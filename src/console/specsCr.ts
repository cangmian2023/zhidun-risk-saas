...
export const crSpecs: Record<string, ModuleSpec> = {
  ...
  'cr:pre-verify': {
    ...
    columns: [
      ...
      { key: 'autoAudit', label: '自动审核', type: 'badge' as const, width: '110px' },
    ],
    rows: [
      {
        ...applications[0],
        id: 'IV-PASS-001',
        fmt: { v: '通过', kind: 'green' },
        three: { v: '一致', kind: 'green' },
        face: { v: '通过', kind: 'green' },
        warn: { v: '无', kind: 'gray' },
        autoAudit: { v: '通过', kind: 'green' },
      },
      {
        ...applications[1],
        id: 'IV-PASS-002',
      ...
      },
      {
        ...
        three: { v: '一致', kind: 'green' },
        face: { v: '通过', kind: 'green' },
        warn: { v: '预警', kind: 'amber' },
        autoAudit: { v: '人工审核', kind: 'amber' },
      },
      {
        ...applications[3],
        id: 'IV-MANUAL-002',
      ...
      },
      {
        ...
        id: 'IV-REJECT-001',
        fmt: { v: '异常', kind: 'red' },
        three: { v: '不一致', kind: 'red' },
        face: { v: '失败', kind: 'red' },
        warn: { v: '逻辑矛盾', kind: 'amber' },
        autoAudit: { v: '拒绝', kind: 'red' },
      },
      {
        ...applications[5],
        id: 'IV-REJECT-002',
