...
// 方案2 差异：双分数体系（自研欺诈汇总分 0-100 + 智察分 0-100），新增「智察分」列
...
const seedRows: FraudRow[] = [
  { id: 'FR-20260618-001', name: '张*伟', product: '信用贷', channel: 'APP', amount: 80000, fraudScore: 12, zhichaScore: 18, sysResult: '处理中', workStatus: '欺诈评估中', operator: '--', auditTime: '2026-06-18 14:32' },
  ...
  { id: 'FR-20260618-005', name: '陈*刚', product: '信用贷', channel: '小程序', amount: 50000, fraudScore: 9, zhichaScore: 14, sysResult: '无风险', workStatus: '已排除', operator: '初审：审核员 1', auditTime: '2026-06-18 16:40' },
  ...
  { id: 'FR-20260619-010', name: '郑*浩', product: '抵押贷', channel: '线下', amount: 680000, fraudScore: 95, zhichaScore: 96, sysResult: '确认欺诈', workStatus: '已加入黑名单办结', operator: '初审：审核员 1；终审：主管 1', auditTime: '2026-06-19 14:30' },
  { id: 'FR-20260618-004', name: '赵*敏', product: '经营贷', channel: 'APP', amount: 200000, fraudScore: 52, zhichaScore: 58, sysResult: '可疑', workStatus: '待复审', operator: '--', auditTime: '2026-06-18 16:05' },
  { id: 'FR-20260618-006', name: '刘*洋', product: '抵押贷', channel: '线下', amount: 350000, fraudScore: 48, zhichaScore: 55, sysResult: '可疑', workStatus: '待复审', operator: '--', auditTime: '2026-06-19 09:12' },
  ...
  { id: 'FR-20260620-012', name: '蒋*磊', product: '经营贷', channel: 'H5', amount: 150000, fraudScore: 44, zhichaScore: 50, sysResult: '可疑', workStatus: '已标记观察', operator: '初审：审核员 1', auditTime: '2026-06-20 10:25' },
  { id: 'FR-20260620-013', name: '韩*梅', product: '信用贷', channel: '小程序', amount: 35000, fraudScore: 56, zhichaScore: 60, sysResult: '可疑', workStatus: '双人复核-排除', operator: '初审：审核员 1；终审：主管 1', auditTime: '2026-06-20 11:15' },
  ...
  { id: 'FR-20260619-008', name: '周*杰', product: '经营贷', channel: 'H5', amount: 90000, fraudScore: 16, zhichaScore: 22, sysResult: '无风险', workStatus: '已排除', operator: '初审：审核员 1', auditTime: '2026-06-19 11:20' },
...
export default function FraudScheme2List() {
  ...
  const goReport = (r: FraudRow) =>
    nav(
      `/console/cr/fraud-s2-detail?sys=${encodeURIComponent(r.sysResult)}&work=${encodeURIComponent(
        r.workStatus,
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      <PageHeader
        crumb="零售信贷风控 / 贷前审核"
        title="欺诈识别（方案2）"
        subtitle="双分数体系：自研欺诈汇总分 + 智察分（同盾原生）· 多源并行欺诈单项 + 交叉融合 + 工单人工处置"
      />
