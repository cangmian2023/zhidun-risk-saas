...
export const creditRiskMenu: MenuGroup[] = [
  ...
  },
  {
    ...
    section: '贷中监控',
    items: [
      { label: '监控任务', key: 'cr:mid-task', desc: '展示所有监控任务，支持按产品、场景、频次筛选' },
      { label: '监控任务', key: 'cr:mid-task-config', desc: '创建/编辑监控任务，配置扫描频次、客群范围、预警规则' },
...
export const scoringMenu: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '违约风险场景', key: 'sc:zhirong-sc-default', desc: '配置违约风险审核场景的评分规则' },
      { label: '授信转化场景', key: 'sc:zhirong-sc-credit', desc: '配置授信申请转化场景的评分规则' },
      { label: '借贷兴趣场景', key: 'sc:zhirong-sc-interest', desc: '配置借贷兴趣场景的评分规则' },
