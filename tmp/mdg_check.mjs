...
function ScoreCardView({ bins }) {
  return /* @__PURE__ */ jsxs("div", { className: "text-[11px] leading-tight", children: [
    /* @__PURE__ */ jsx("div", { className: "mb-1 font-semibold text-slate-700", children: "\u57FA\u7840\u5206 600 + \u5404\u56E0\u5B50\u67E5\u8868\u52A0\u5206" }),
    bins.map((f) => /* @__PURE__ */ jsxs("div", { className: "mb-1", children: [
      /* @__PURE__ */ jsx("div", { className: "text-slate-600", children: f.name }),
      /* @__PURE__ */ jsx("div", { className: "text-slate-400", children: f.bins.map((b) => /* @__PURE__ */ jsxs("span", { className: "mr-2 inline-block", children: [
        b.label,
        " ",
        /* @__PURE__ */ jsxs("span", { className: b.points >= 0 ? "text-emerald-600" : "text-rose-600", children: [
          b.points >= 0 ? "+" : "",
          b.points
        ] })
      ] }, b.label)) })
    ] }, f.key)),
    /* @__PURE__ */ jsx("div", { className: "mt-1 border-t border-slate-100 pt-1 text-slate-500", children: "\u5408\u8BA1 = 600 + \u03A3\u52A0\u5206\uFF0C\u88C1\u526A [300,900]" })
  ] });
}
var HINT_TONE = {
...
function ModelDecisionGraph({
  ...
  const [openNodes, setOpenNodes] = useState(/* @__PURE__ */ new Set());
  ...
  const TBtn = ({ onClick, title, children }) => /* @__PURE__ */ jsx("button", { onClick, title, className: "h-7 min-w-7 rounded-md border border-slate-200 bg-white px-2 text-xs text-slate-600 hover:border-brand-400 hover:bg-slate-50", children });
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          isEditable && editMode && /* @__PURE__ */ jsxs("aside", { className: "z-30 flex w-[188px] shrink-0 flex-col border-r border-slate-200 bg-white", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-slate-100 px-3 py-2", children: [
              /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-slate-600", children: "\u6DFB\u52A0\u8282\u70B9" }),
              /* @__PURE__ */ jsxs("span", { className: "rounded bg-slate-100 px-1.5 py-0.5 text-[10px] text-slate-400", children: [
                graph.nodes.length,
                " \u4E2A"
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "px-3 pb-2 pt-2", children: /* @__PURE__ */ jsx(
              "input",
              {
                value: nodeFilter,
            ...
            /* @__PURE__ */ jsx("div", { className: "flex-1 space-y-3 overflow-y-auto px-3 pb-3", children: NODE_CATEGORY.map((cat) => {
              const items = cat.types.filter((t) => GNODE_META[t].label.includes(nodeFilter) || nodeFilter === "");
              if (!items.length) return null;
              return /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "mb-1 text-[10px] font-medium uppercase tracking-wide text-slate-400", children: cat.label }),
                /* @__PURE__ */ jsx("div", { className: "space-y-1", children: items.map((t) => /* @__PURE__ */ jsxs(
                  "button",
                  {
                    onClick: () => addNode(t),
                    ...
                    children: [
                      /* @__PURE__ */ jsx("span", { className: "h-3 w-3 shrink-0 rounded-sm", style: { background: GNODE_META[t].color } }),
                      /* @__PURE__ */ jsx("span", { className: "truncate", children: GNODE_META[t].label })
                    ]
                  },
                  t
                )) })
            ...
            /* @__PURE__ */ jsx("div", { className: "border-t border-slate-100 p-2", children: /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => {
                  setLinkMode((v) => !v);
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-1 flex-col", children: [
            /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-20 flex shrink-0 flex-wrap items-center gap-1 border-b border-slate-200 bg-white/95 px-2 py-1.5 backdrop-blur", children: [
              /* @__PURE__ */ jsx("span", { className: "mr-1 text-[11px] text-slate-400", children: "\u7F29\u653E" }),
              /* @__PURE__ */ jsx(TBtn, { onClick: () => zoom(-0.1), title: "\u7F29\u5C0F", children: "\u2212" }),
              /* @__PURE__ */ jsxs("span", { className: "w-12 text-center text-xs tabular-nums text-slate-500", children: [
                Math.round(scale * 100),
                "%"
              ] }),
              /* @__PURE__ */ jsx(TBtn, { onClick: () => zoom(0.1), title: "\u653E\u5927", children: "\uFF0B" }),
              /* @__PURE__ */ jsx(TBtn, { onClick: fit, title: "\u9002\u5E94\u5C4F\u5E55", children: "\u9002\u5E94" }),
              /* @__PURE__ */ jsx(TBtn, { onClick: () => setScale(1), title: "\u539F\u59CB\u5927\u5C0F 100%", children: "1:1" }),
              /* @__PURE__ */ jsx("span", { className: "mx-1 h-5 w-px bg-slate-200" }),
              /* @__PURE__ */ jsx("span", { className: "mr-1 text-[11px] text-slate-400", children: "\u89C6\u56FE" }),
              /* @__PURE__ */ jsx(TBtn, { onClick: resetView, title: "\u590D\u4F4D\uFF08\u7F29\u653E+\u5E73\u79FB\u5F52\u96F6\uFF09", children: "\u590D\u4F4D" }),
              /* @__PURE__ */ jsx(TBtn, { onClick: toggleFs, title: isFs ? "\u9000\u51FA\u5168\u5C4F" : "\u5168\u5C4F", children: isFs ? "\u9000\u51FA\u5168\u5C4F" : "\u5168\u5C4F" }),
              /* @__PURE__ */ jsx("span", { className: "mx-1 h-5 w-px bg-slate-200" }),
              /* @__PURE__ */ jsx("span", { className: "mr-1 text-[11px] text-slate-400", children: "\u9AD8\u4EAE" }),
              /* @__PURE__ */ jsx(TBtn, { onClick: () => {
                setHi("main");
                setFocus(null);
              ...
              isEditable && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("span", { className: "mx-1 h-5 w-px bg-slate-200" }),
                /* @__PURE__ */ jsx("span", { className: "mr-1 text-[11px] text-slate-400", children: "\u7F16\u8F91" }),
                /* @__PURE__ */ jsx(TBtn, { onClick: () => {
                  setEditMode((v) => !v);
                  setLinkMode(false);
                  setLinkFrom(null);
                }, title: editMode ? "\u9000\u51FA\u753B\u5E03\u7F16\u8F91" : "\u8FDB\u5165\u753B\u5E03\u7F16\u8F91\uFF08\u6DFB\u52A0\u8282\u70B9 / \u8FDE\u7EBF / \u5220\u9664\uFF09", children: editMode ? "\u5B8C\u6210\u7F16\u8F91" : "\u7F16\u8F91\u753B\u5E03" }),
                editMode && dirty && /* @__PURE__ */ jsx("button", { onClick: saveGraph, title: "\u4FDD\u5B58\u5F53\u524D\u753B\u5E03\uFF08\u8282\u70B9 / \u8FDE\u7EBF / \u4F4D\u7F6E\uFF09\u5230\u6A21\u578B\u914D\u7F6E", className: "h-7 rounded-md bg-brand-600 px-3 text-xs font-medium text-white hover:bg-brand-700", children: "\u4FDD\u5B58\u753B\u5E03" })
              ] }),
              /* @__PURE__ */ jsx("span", { className: "ml-2 text-[11px] text-slate-300", children: editMode && linkMode ? linkFrom ? "\u8FDE\u7EBF\u4E2D \xB7 \u70B9\u51FB\u7EC8\u70B9\u8282\u70B9\u5B8C\u6210\u8FDE\u7EBF" : "\u8FDE\u7EBF\u6A21\u5F0F \xB7 \u70B9\u51FB\u8D77\u70B9\u8282\u70B9" : "\u62D6\u62FD\u8282\u70B9\u53EF\u8C03\u6574\u4F4D\u7F6E \xB7 \u70B9\u51FB\u8282\u70B9\u67E5\u770B\u8BE6\u60C5\u5E76\u9AD8\u4EAE\u5176\u6574\u6761\u94FE\u8DEF" })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "relative flex-1 overflow-auto", children: /* @__PURE__ */ jsxs(
              "div",
              {
                style: {
                ...
                children: [
                  /* @__PURE__ */ jsxs("svg", { width: graph.width, height: graph.height, className: "pointer-events-none absolute left-0 top-0", children: [
                    /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsx("marker", { id: "arrow", markerWidth: "10", markerHeight: "10", refX: "8", refY: "3", orient: "auto", markerUnits: "strokeWidth", children: /* @__PURE__ */ jsx("path", { d: "M0,0 L8,3 L0,6 Z", fill: "#94A3B8" }) }) }),
                    graph.edges.map((e, i) => {
                      ...
                      const dim = edgeDim(e);
                      return /* @__PURE__ */ jsxs("g", { style: { opacity: dim ? 0.18 : 1, transition: "opacity .15s" }, children: [
                        /* @__PURE__ */ jsx("path", { d, fill: "none", stroke: col, strokeWidth: isAlertEdge(e) ? 2 : 1.5, strokeDasharray: e.dashed ? "5 4" : void 0, markerEnd: "url(#arrow)" }),
                        e.label && /* @__PURE__ */ jsx("text", { x: midX, y: (a.y + b.y) / 2 - 6, textAnchor: "middle", fontSize: 11, fill: col, children: e.label }),
                        editMode && /* @__PURE__ */ jsx(
                          "path",
                          {
                            ...
                            children: /* @__PURE__ */ jsx("title", { children: "\u70B9\u51FB\u5220\u9664\u8BE5\u8FDE\u7EBF" })
                          }
                        )
                      ] }, i);
                    })
                  ...
                  graph.nodes.map((n) => {
                    ...
                    return /* @__PURE__ */ jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center justify-between rounded-t-xl px-3 py-1.5", style: { background: headerBg }, children: [
                            /* @__PURE__ */ jsx("span", { className: "text-xs font-semibold text-white", children: n.title }),
                            /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5", children: [
                              isCollision && onSaveCollisions && /* @__PURE__ */ jsx("span", { className: "rounded bg-white/25 px-1 py-0.5 text-[10px] font-medium text-white", children: "\u53EF\u7F16\u8F91" }),
                              n.badge && /* @__PURE__ */ jsx("span", { className: "rounded-full bg-white/25 px-1.5 py-0.5 text-[10px] font-medium text-white", children: n.badge })
                            ] })
                          ] }),
                          /* @__PURE__ */ jsxs("div", { className: "min-h-0 flex-1 overflow-y-auto px-3 py-1.5", children: [
                            nodeResults?.[n.id] && /* @__PURE__ */ jsx("div", { className: "mb-1.5 rounded-md border px-1.5 py-1 text-[11px] font-semibold leading-snug " + hintTone(nodeResults?.[n.id]), children: nodeResults[n.id] }),
                            cardBins ? /* @__PURE__ */ jsx(ScoreCardView, { bins: cardBins }) : /* @__PURE__ */ jsxs(Fragment, { children: [
                              n.subtitle && /* @__PURE__ */ jsx("div", { className: "mb-1 text-[11px] text-slate-400", children: n.subtitle }),
                              /* @__PURE__ */ jsx("div", { className: "space-y-0.5 opacity-60", children: metaOf(n).map((m, i) => /* @__PURE__ */ jsx("div", { className: `whitespace-normal break-words text-[10.5px] leading-tight text-slate-500 ${!openNodes.has(n.id) && i > 0 ? "hidden" : ""}`, children: m }, i)) }),
                              metaOf(n).length > 1 && /* @__PURE__ */ jsx("button", { onClick: () => toggleNode(n.id), className: "mt-0.5 text-[10px] text-blue-500 hover:underline", children: openNodes.has(n.id) ? "\u6536\u8D77\u8BF4\u660E" : "\u5C55\u5F00\u8BF4\u660E" })
                            ] })
                          ] })
                        ]
                      },
          ...
          selected && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-10 bottom-0 z-30 flex w-[360px] max-w-[80%] flex-col border-l border-slate-200 bg-white shadow-2xl", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-slate-100 px-4 py-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "h-3 w-3 rounded-sm", style: { background: GNODE_META[selected.type].color } }),
                /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-slate-800", children: selected.title })
              ] }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-3 overflow-y-auto px-4 py-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 text-xs", children: [
                /* @__PURE__ */ jsx("span", { className: "rounded-full bg-slate-100 px-2 py-0.5 text-slate-500", children: GNODE_META[selected.type].label }),
                selected.subtitle && /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: selected.subtitle }),
                selected.badge && /* @__PURE__ */ jsx("span", { className: "rounded-full bg-brand-50 px-2 py-0.5 text-brand-600", children: selected.badge })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "mb-1 text-xs font-medium text-slate-500", children: "\u672C\u5BA2\u6237\u503C" }),
                /* @__PURE__ */ jsx("div", { className: "rounded-lg border px-3 py-2 text-[12.5px] font-semibold leading-relaxed " + hintTone(nodeResults?.[selected.id]), children: nodeResults?.[selected.id] ?? "\u2014\uFF08\u8BE5\u8282\u70B9\u65E0\u672C\u5BA2\u6237\u53D6\u503C\uFF09" })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "mb-1 text-xs font-medium text-slate-500", children: "\u8BF4\u660E" }),
                /* @__PURE__ */ jsx("div", { className: "rounded-lg bg-slate-50 px-3 py-2 text-[12px] leading-relaxed text-slate-600", children: (metaOf(selected).length ? metaOf(selected) : ["\uFF08\u8BE5\u8282\u70B9\u65E0\u989D\u5916\u914D\u7F6E\u8BF4\u660E\uFF09"]).map((m, i) => /* @__PURE__ */ jsx("div", { className: "whitespace-pre-wrap", children: m }, i)) })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "mb-1 text-xs font-medium text-slate-500", children: "\u8F93\u5165\uFF08\u4E0A\u6E38\u8282\u70B9\uFF09" }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
                  inputsOf(selected.id).map((t, i) => /* @__PURE__ */ jsx("span", { className: "rounded bg-slate-100 px-2 py-0.5 text-[11px] text-slate-600", children: t }, i)),
                  inputsOf(selected.id).length === 0 && /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300", children: "\u65E0\uFF08\u8D77\u70B9\u8282\u70B9\uFF09" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("div", { className: "mb-1 text-xs font-medium text-slate-500", children: "\u8F93\u51FA\uFF08\u4E0B\u6E38\u8282\u70B9\uFF09" }),
                /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1.5", children: [
                  outputsOf(selected.id).map((t, i) => /* @__PURE__ */ jsx("span", { className: "rounded bg-slate-100 px-2 py-0.5 text-[11px] text-slate-600", children: t }, i)),
                  outputsOf(selected.id).length === 0 && /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300", children: "\u65E0\uFF08\u7EC8\u70B9\u8282\u70B9\uFF09" })
                ] })
              ] }),
              selected.type === "collision" && onSaveCollisions && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsx("p", { className: "text-xs leading-relaxed text-slate-400", children: "\u5F53\u591A\u6761\u89C4\u5219\u540C\u65F6\u547D\u4E2D\u4EA7\u751F\u51B2\u7A81\u65F6\uFF0C\u6309\u6B64\u88C1\u51B3\u903B\u8F91\u53D6\u820D\u5E76\u751F\u6210\u5BF9\u5E94\u7684\u9884\u8B66\u7B49\u7EA7\u3002\u4FEE\u6539\u4EC5\u5F71\u54CD\u672C\u6A21\u578B\u7684\u914D\u7F6E\uFF0C\u4FDD\u5B58\u540E\u968F\u6A21\u578B\u6301\u4E45\u5316\u3002" }),
                /* @__PURE__ */ jsx("button", { onClick: () => {
                  setSelected(null);
                  setFocus(null);
                  openCollision();
              ...
              editMode && /* @__PURE__ */ jsxs(Fragment, { children: [
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("div", { className: "mb-1 text-xs font-medium text-slate-500", children: "\u8282\u70B9\u6807\u9898" }),
                  /* @__PURE__ */ jsx(
                    "input",
                    {
          ...
          editingCollision && onSaveCollisions && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-40 flex justify-end bg-black/20", onClick: () => setEditingCollision(false), children: /* @__PURE__ */ jsxs("div", { className: "flex h-full w-[440px] max-w-[90%] flex-col bg-white shadow-xl", onClick: (e) => e.stopPropagation(), children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-slate-100 px-4 py-3", children: [
              /* @__PURE__ */ jsxs("div", { className: "text-sm font-semibold text-slate-800", children: [
                "\u89C4\u5219\u78B0\u649E \xB7 \u51B2\u7A81\u88C1\u51B3 ",
                /* @__PURE__ */ jsx("span", { className: "ml-1 text-xs font-normal text-slate-400", children: SCORE_PROD_LABEL[prod] })
              ] }),
              /* @__PURE__ */ jsx("button", { onClick: () => setEditingCollision(false), className: "rounded-md px-2 py-1 text-sm text-slate-400 hover:bg-slate-100", children: "\u5173\u95ED" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 space-y-3 overflow-y-auto px-4 py-3", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400", children: "\u5B9A\u4E49\u5F53\u591A\u6761\u89C4\u5219\u540C\u65F6\u547D\u4E2D\u4EA7\u751F\u51B2\u7A81\u65F6\u5982\u4F55\u88C1\u51B3\u3001\u5E76\u751F\u6210\u4F55\u79CD\u9884\u8B66\u3002\u6B64\u5373\u6A21\u578B\u914D\u7F6E\u9636\u6BB5\u7684\u51B2\u7A81\u903B\u8F91\uFF0C\u4FDD\u5B58\u540E\u968F\u6A21\u578B\u6301\u4E45\u5316\u3002" }),
              localRules.map((r, i) => /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-slate-200 p-3", children: [
                /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxs("span", { className: "text-xs font-medium text-slate-500", children: [
                    "\u88C1\u51B3\u89C4\u5219 ",
                    i + 1
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-1 text-xs text-slate-500", children: [
                      /* @__PURE__ */ jsx("input", { type: "checkbox", checked: r.enabled, onChange: () => toggleRule(r.id), className: "accent-rose-500" }),
                      " \u542F\u7528"
                    ] }),
                    /* @__PURE__ */ jsx("button", { onClick: () => removeRule(r.id), className: "text-xs text-rose-500 hover:underline", children: "\u5220\u9664" })
                  ] })
                ] }),
                /* @__PURE__ */ jsx(
                  "input",
                ...
                /* @__PURE__ */ jsxs(
                  "select",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("option", { value: "\u62E6\u622A\u4F18\u5148", children: "\u4F18\u5148\u7EA7\uFF1A\u62E6\u622A\u4F18\u5148\uFF08\u89C4\u5219/\u540D\u5355\u538B\u8FC7\u5206\u6570\uFF09" }),
                      /* @__PURE__ */ jsx("option", { value: "\u5206\u6570\u4F18\u5148", children: "\u4F18\u5148\u7EA7\uFF1A\u5206\u6570\u4F18\u5148\uFF08\u6A21\u578B\u5206\u51B3\u5B9A\uFF09" }),
                      /* @__PURE__ */ jsx("option", { value: "\u8F6C\u4EBA\u5DE5", children: "\u4F18\u5148\u7EA7\uFF1A\u8F6C\u4EBA\u5DE5\u590D\u6838" })
                    ]
                  }
                )
              ] }, r.id)),
              localRules.length === 0 && /* @__PURE__ */ jsx("div", { className: "rounded-lg border border-dashed border-slate-200 px-3 py-6 text-center text-xs text-slate-400", children: "\u6682\u65E0\u51B2\u7A81\u88C1\u51B3\u89C4\u5219\uFF0C\u70B9\u51FB\u4E0B\u65B9\u65B0\u589E\u3002" }),
              /* @__PURE__ */ jsx("button", { onClick: addRule, className: "w-full rounded-lg border border-dashed border-slate-300 py-2 text-sm text-slate-500 hover:border-brand-400 hover:text-brand-600", children: "\uFF0B \u65B0\u589E\u51B2\u7A81\u88C1\u51B3\u89C4\u5219" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex gap-2 border-t border-slate-100 px-4 py-3", children: [
              /* @__PURE__ */ jsx("button", { onClick: saveCollision, className: "flex-1 rounded-lg bg-brand-600 px-3 py-2 text-sm font-medium text-white hover:bg-brand-700", children: "\u4FDD\u5B58" }),
              /* @__PURE__ */ jsx("button", { onClick: () => setEditingCollision(false), className: "rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-600 hover:bg-slate-50", children: "\u53D6\u6D88" })
            ] })
          ] }) })
        ]
      }
    ...
    /* @__PURE__ */ jsxs("div", { className: "mt-2 flex flex-wrap items-center gap-3", children: [
      Object.keys(GNODE_META).map((t) => /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 text-xs text-slate-500", children: [
        /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 rounded-sm", style: { background: GNODE_META[t].color } }),
        GNODE_META[t].label
      ] }, t)),
      /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 text-xs text-slate-500", children: [
        /* @__PURE__ */ jsx("span", { className: "inline-block h-0 w-5 border-t-2 border-dashed border-cyan-500" }),
        "\u5E76\u884C\u9884\u8B66\uFF08\u865A\u7EBF\uFF09"
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4 overflow-hidden rounded-xl border border-slate-200", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-slate-100 bg-slate-50 px-3 py-2", children: [
        /* @__PURE__ */ jsx("div", { className: "text-sm font-semibold text-slate-800", children: "\u8282\u70B9\u660E\u7EC6 \xB7 \u6BCF\u4E2A\u8282\u70B9\u7684\u8BF4\u660E / \u8F93\u5165 / \u8F93\u51FA" }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsx("div", { className: "max-h-[340px] overflow-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsx("thead", { className: "sticky top-0 bg-slate-50", children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-xs text-slate-400", children: [
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u8282\u70B9" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u7C7B\u578B" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u7ED3\u679C\uFF08\u672C\u5BA2\u6237\u5728\u6B64\u8282\u70B9\u7684\u8F93\u51FA\uFF09" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u8BF4\u660E" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u8F93\u5165\uFF08\u4E0A\u6E38\uFF09" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u8F93\u51FA\uFF08\u4E0B\u6E38\uFF09" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { children: graph.nodes.map((n) => {
          const open = openNodes.has(n.id);
          const ins = inputsOf(n.id);
          const outs = outputsOf(n.id);
          const m = metaOf(n);
          return /* @__PURE__ */ jsxs("tr", { className: "border-t border-slate-50 align-top", children: [
            /* @__PURE__ */ jsx("td", { className: "px-3 py-2", children: /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsx("span", { className: "h-2.5 w-2.5 shrink-0 rounded-sm", style: { background: GNODE_META[n.type].color } }),
              /* @__PURE__ */ jsx("span", { className: "font-medium text-slate-700", children: n.title }),
              n.badge && /* @__PURE__ */ jsx("span", { className: "rounded-full bg-brand-50 px-1.5 py-0.5 text-[10px] text-brand-600", children: n.badge })
            ] }) }),
            /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-slate-500", children: GNODE_META[n.type].label }),
            /* @__PURE__ */ jsx("td", { className: "px-3 py-2", children: nodeResults?.[n.id] ? /* @__PURE__ */ jsx("span", { className: "inline-block max-w-[240px] whitespace-pre-wrap rounded-md border px-2 py-1 text-[11px] font-medium leading-snug " + hintTone(nodeResults?.[n.id]), children: nodeResults[n.id] }) : /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300", children: "\u2014" }) }),
            /* @__PURE__ */ jsxs("td", { className: "px-3 py-2 text-slate-600", children: [
              /* @__PURE__ */ jsx("div", { className: "space-y-0.5", children: m.length ? m.map((t, i) => /* @__PURE__ */ jsx("div", { className: `whitespace-pre-wrap text-[12px] leading-tight ${!open && i > 0 ? "hidden" : ""}`, children: t }, i)) : /* @__PURE__ */ jsx("span", { className: "text-[12px] text-slate-300", children: "\uFF08\u65E0\uFF09" }) }),
              m.length > 1 && /* @__PURE__ */ jsx("button", { onClick: () => toggleNode(n.id), className: "mt-1 text-[11px] text-blue-600 hover:underline", children: open ? "\u6536\u8D77" : "\u5C55\u5F00\u8BF4\u660E" })
            ] }),
            /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-slate-600", children: ins.length ? ins.map((t, i) => /* @__PURE__ */ jsx("span", { className: "mr-1 mb-1 inline-block rounded bg-slate-100 px-1.5 py-0.5 text-[11px] text-slate-600", children: t }, i)) : /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300", children: "\u65E0" }) }),
            /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-slate-600", children: outs.length ? outs.map((t, i) => /* @__PURE__ */ jsx("span", { className: "mr-1 mb-1 inline-block rounded bg-slate-100 px-1.5 py-0.5 text-[11px] text-slate-600", children: t }, i)) : /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300", children: "\u65E0" }) })
          ] }, n.id);
        }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mt-4 overflow-hidden rounded-xl border border-slate-200", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-slate-100 bg-slate-50 px-3 py-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm font-semibold text-slate-800", children: [
          "\u51B3\u7B56\u6620\u5C04 \xB7 \u8F93\u51FA\u5206\u6570\u5982\u4F55\u53D8\u6210\u5904\u7F6E\u52A8\u4F5C",
          /* @__PURE__ */ jsx("span", { className: "rounded bg-slate-100 px-1.5 py-0.5 text-[10px] font-normal text-slate-400", children: "\u53EA\u8BFB \xB7 \u6570\u636E\u6765\u81EA\u300C\u8BC4\u5206\u9608\u503C\u300D" })
        ] }),
        /* @__PURE__ */ jsx("button", { onClick: onJumpStrategy, className: "text-xs text-blue-600 hover:underline", children: "\u5728\u89C4\u5219\u5F15\u64CE\u914D\u7F6E \u2192" })
      ] }),
      /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "text-left text-xs text-slate-400", children: [
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u5206\u6570\u6BB5" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u7B49\u7EA7" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u542B\u4E49" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u5EFA\u8BAE\u52A8\u4F5C\uFF08\u9608\u503C\u89C4\u5219\uFF09" }),
          /* @__PURE__ */ jsx("th", { className: "px-3 py-2 font-medium", children: "\u6267\u884C\u5F15\u64CE" })
        ] }) }),
        /* @__PURE__ */ jsxs("tbody", { children: [
          rows.map((t) => {
            const hit = hitRow?.range === t.range;
            return /* @__PURE__ */ jsxs("tr", { className: "border-t border-slate-50", style: hit ? { background: "#EFF6FF", boxShadow: "inset 3px 0 0 #2563EB" } : void 0, children: [
              /* @__PURE__ */ jsxs("td", { className: "px-3 py-2 tabular-nums text-slate-700", children: [
                t.range,
                hit && /* @__PURE__ */ jsxs("span", { className: "ml-2 rounded-full bg-blue-600 px-1.5 py-0.5 text-[10px] font-medium text-white", children: [
                  "\u25C0 \u672C\u5BA2\u6237 ",
                  currentScore,
                  " \u5206"
                ] })
              ] }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 font-semibold", style: hit ? { color: "#1D4ED8" } : { color: "#334155" }, children: t.level }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2", style: hit ? { color: "#1E40AF" } : { color: "#64748B" }, children: t.meaning }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2", style: hit ? { color: "#1E40AF", fontWeight: 600 } : { color: "#334155" }, children: t.action }),
              /* @__PURE__ */ jsx("td", { className: "px-3 py-2 text-sky-500", children: "\u89C4\u5219\u5F15\u64CE" })
            ] }, t.range);
          }),
          rows.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 5, className: "px-3 py-3 text-center text-xs text-slate-400", children: "\u5F53\u524D\u6A21\u578B\u6682\u65E0\u9608\u503C\u51B3\u7B56\u914D\u7F6E" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-t border-slate-100 bg-slate-50 px-3 py-2 text-[11px] text-slate-400", children: [
        /* @__PURE__ */ jsx("span", { children: "\u9608\u503C\u89C4\u5219\u4E0E\u9884\u8B66\u89C4\u5219\u5747\u7531\u89C4\u5219\u5F15\u64CE\u5B50\u7CFB\u7EDF\u7EDF\u4E00\u6267\u884C\uFF1B\u94FE\u8DEF\u5B9E\u4F53\u5747\u6765\u81EA\u771F\u5B9E\u914D\u7F6E\uFF08scoreData.json / ruleHub.json\uFF09\uFF0C\u975E\u793A\u610F\u3002" }),
        /* @__PURE__ */ jsx("button", { onClick: onJumpRules, className: "ml-3 shrink-0 text-xs text-blue-600 hover:underline", children: "\u5728\u89C4\u5219\u5F15\u64CE\u67E5\u770B\u5168\u90E8\u89C4\u5219 \u2192" })
      ] })
    ] })
  ] });
}
export {
  ModelDecisionGraph as default
};
