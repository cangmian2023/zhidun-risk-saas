// src/console/EnterprisePages.tsx
...
var FILES = { ent: "enterpriseData.json" };
var data = JSON.parse(JSON.stringify(SEED_ENTERPRISE));
var version = 0;
var saveStatus = null;
...
function updateEnterpriseData(fn) {
  data = fn(data);
  emit2();
  saveOne(FILES.ent, data);
}
...
var FILES2 = { qiye: "qiyeData.json" };
var data2 = JSON.parse(JSON.stringify(SEED_QIYE));
var version2 = 0;
...
async function bootstrap2() {
  const saved = await loadOne2(FILES2.qiye);
  if (saved && typeof saved === "object" && Array.isArray(saved.enterprises)) {
    data2 = saved;
  } else {
    saveOne2(FILES2.qiye, data2);
  }
  emit3();
}
void bootstrap2();
  ...
  return /* @__PURE__ */ jsxs5("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx5(
      PageShell,
      {
        ...
        actions: /* @__PURE__ */ jsxs5(Fragment6, { children: [
          /* @__PURE__ */ jsx5(Sam, { label: "\u4F01\u4E1A\u6837\u4F8B", value: "qiyeData.json.enterprises" }),
          /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsx5(Panel, { title: "\u68C0\u7D22", desc: /* @__PURE__ */ jsxs5("span", { children: [
      "\u5171 ",
      /* @__PURE__ */ jsx5("b", { children: d.enterprises.length }),
      " \u5BB6\u5728\u6863\u4F01\u4E1A \xB7 ",
      /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u6C47\u603B" })
    ] }), children: /* @__PURE__ */ jsxs5("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }, children: [
      /* @__PURE__ */ jsx5(
        "input",
        {
          value: kw,
      ...
      /* @__PURE__ */ jsxs5("span", { style: { fontSize: 12, color: "#94A3B8" }, children: [
        "\u547D\u4E2D ",
        list.length,
        " \u5BB6"
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(420px, 1fr))", gap: 12, marginTop: 16 }, children: [
      list.map((e) => /* @__PURE__ */ jsxs5(
        "div",
        {
          style: { border: "1px solid #E2E8F0", borderRadius: 12, padding: 16, background: "#fff", cursor: "pointer" },
          onClick: () => open(e),
          children: [
            /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }, children: [
              /* @__PURE__ */ jsx5("div", { style: { fontSize: 15, fontWeight: 700, color: "#0F172A" }, children: e.name }),
              /* @__PURE__ */ jsx5(Badge, { kind: STATUS_KIND[e.status], children: e.status })
            ] }),
            /* @__PURE__ */ jsx5("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginTop: 6 }, children: e.tags.map((t) => /* @__PURE__ */ jsx5(Badge, { kind: "blue", children: t }, t)) }),
            /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 16px", fontSize: 12, color: "#475569", marginTop: 10 }, children: [
              ...
              /* @__PURE__ */ jsxs5("div", { children: [
                "\u79D1\u521B\u5206\uFF1A",
                /* @__PURE__ */ jsx5("b", { style: { color: "#0EA5E9" }, children: e.kcScore })
              ] })
            ] }),
            /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 12 }, children: [
              /* @__PURE__ */ jsxs5("span", { style: { fontSize: 11, color: "#94A3B8" }, children: [
                "\u6807\u8BC6 ",
                e.keyNo.slice(0, 12),
                "\u2026"
              ] }),
              /* @__PURE__ */ jsx5(Button, { size: "sm", onClick: (ev) => {
                ev.stopPropagation();
                open(e);
              }, children: "\u67E5\u770B\u6863\u6848" })
            ] })
      ...
      !list.length && /* @__PURE__ */ jsx5("div", { style: { color: "#94A3B8", fontSize: 13, padding: 24 }, children: "\u672A\u68C0\u7D22\u5230\u5339\u914D\u4F01\u4E1A" })
    ] })
  ] });
}
function CountGrid({ title, items }) {
  return /* @__PURE__ */ jsx5(Panel, { title, desc: /* @__PURE__ */ jsxs5("span", { children: [
    "\u5B50\u9879\u7EDF\u8BA1 \xB7 ",
    /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
  ] }), children: /* @__PURE__ */ jsx5("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(150px, 1fr))", gap: 8 }, children: items.map((it) => /* @__PURE__ */ jsxs5("div", { style: { border: "1px solid #E2E8F0", borderRadius: 8, padding: "8px 10px", display: "flex", alignItems: "center", justifyContent: "space-between", background: it.danger && it.count > 0 ? "#FEF2F2" : "#fff" }, children: [
    /* @__PURE__ */ jsx5("span", { style: { fontSize: 12, color: it.danger && it.count > 0 ? "#DC2626" : "#475569" }, children: it.name }),
    /* @__PURE__ */ jsx5("span", { style: { fontSize: 13, fontWeight: 600, color: it.danger && it.count > 0 ? "#DC2626" : "#334155" }, children: it.count })
  ] }, it.name)) }) });
}
...
function QiyeProfile() {
  ...
  const [cur, setCur] = useState5(init ?? d.enterprises[0]);
  const [tab, setTab] = useState5("\u98CE\u9669\u753B\u50CF");
  if (!cur) return /* @__PURE__ */ jsx5("div", { style: { padding: 24 }, children: "\u6682\u65E0\u4F01\u4E1A\u6863\u6848" });
  const shCols = [
  ...
  return /* @__PURE__ */ jsxs5("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx5(
      PageShell,
      {
        ...
        actions: /* @__PURE__ */ jsxs5(Fragment6, { children: [
          /* @__PURE__ */ jsx5(Sam, { label: "\u4F01\u4E1A\u6837\u4F8B", value: "qiyeData.json" }),
          /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs5("div", { style: { border: "1px solid #E2E8F0", borderRadius: 12, padding: 16, background: "#fff", marginBottom: 12 }, children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
          /* @__PURE__ */ jsx5("div", { style: { width: 52, height: 52, borderRadius: 10, background: "linear-gradient(135deg,#0EA5E9,#22D3EE)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, fontWeight: 700 }, children: cur.name.slice(0, 1) }),
          /* @__PURE__ */ jsxs5("div", { children: [
        ...
        /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: [
          /* @__PURE__ */ jsxs5("div", { style: { textAlign: "right" }, children: [
            /* @__PURE__ */ jsx5("div", { style: { fontSize: 12, color: "#94A3B8" }, children: "\u79D1\u521B\u5206" }),
            /* @__PURE__ */ jsx5("div", { style: { fontSize: 22, fontWeight: 800, color: "#0EA5E9" }, children: cur.kcScore })
          ] }),
          /* @__PURE__ */ jsx5(Button, { size: "sm", variant: cur.followed ? "secondary" : "primary", onClick: () => toggleFollow(cur.keyNo), children: cur.followed ? "\u5DF2\u5173\u6CE8" : "\uFF0B \u5173\u6CE8" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs5("div", { style: { display: "flex", gap: 18, flexWrap: "wrap", marginTop: 14, fontSize: 13, color: "#475569" }, children: [
        ...
        /* @__PURE__ */ jsxs5("span", { children: [
          "\u6210\u7ACB\u65E5\u671F\uFF1A",
          /* @__PURE__ */ jsx5("b", { children: cur.regDate })
        ] }),
        /* @__PURE__ */ jsxs5("span", { children: [
          "\u6CD5\u5B9A\u4EE3\u8868\u4EBA\uFF1A",
          /* @__PURE__ */ jsx5("b", { children: cur.legalPerson })
        ] }),
        /* @__PURE__ */ jsxs5("span", { children: [
          "\u53C2\u4FDD\u4EBA\u6570\uFF1A",
          /* @__PURE__ */ jsx5("b", { children: cur.employees.toLocaleString() })
        ] }),
        /* @__PURE__ */ jsxs5("span", { children: [
          "\u884C\u4E1A\uFF1A",
          /* @__PURE__ */ jsx5("b", { children: cur.industry })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsx5("div", { style: { display: "flex", gap: 4, borderBottom: "1px solid #E2E8F0", marginBottom: 14, flexWrap: "wrap" }, children: TABS.map((t) => {
      const bg = tabBadge(t);
      return /* @__PURE__ */ jsxs5(
        "button",
        {
          ...
          children: [
            t,
            bg && /* @__PURE__ */ jsx5("span", { style: { fontSize: 10, fontWeight: 600, lineHeight: 1, padding: "2px 6px", borderRadius: 999, background: bg.danger ? "#FEE2E2" : "#E0F2FE", color: bg.danger ? "#B91C1C" : "#0369A1" }, children: bg.n })
          ]
        },
        t
      );
    }) }),
    tab === "\u98CE\u9669\u753B\u50CF" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u7EFC\u5408\u98CE\u9669\u7B49\u7EA7", value: riskLevel, accent: riskLevelKind(riskLevel), hint: /* @__PURE__ */ jsx5(Cal, { label: "\u6A21\u578B+\u76D1\u63A7\u540D\u5355" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u7D2F\u8BA1\u9884\u8B66", value: String(mon.alerts), accent: "amber", hint: mon.lastAlert !== "\u2014" ? `\u6700\u8FD1 ${mon.lastAlert}` : "\u65E0\u9884\u8B66" }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u53F8\u6CD5\u6D89\u8BC9", value: String(riskCases), accent: riskCases > 0 ? "rose" : "green", hint: "\u88C1\u5224\u6587\u4E66 + \u7ACB\u6848" }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u98CE\u9669\u547D\u4E2D\u9879", value: String(dangerCount), accent: dangerCount > 0 ? "rose" : "green", hint: "\u7ECF\u8425\u98CE\u9669\u547D\u4E2D" })
      ] }),
      /* @__PURE__ */ jsx5(Panel, { title: "\u98CE\u9669\u6A21\u578B\u7ED3\u679C", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u4F01\u4E1A\u98CE\u63A7\u6A21\u578B\u8BC4\u5206\u4E0E\u98CE\u9669\u7ED3\u8BBA \xB7 ",
        /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u8BA1\u7B97" }),
        " \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "enterpriseData.json.models" })
      ] }), children: /* @__PURE__ */ jsx5("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: 12 }, children: ent.models.map((m) => {
        ...
        return /* @__PURE__ */ jsxs5("div", { style: { border: "1px solid #E2E8F0", borderRadius: 12, padding: 14, background: "#F8FAFC" }, children: [
          /* @__PURE__ */ jsxs5("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
            /* @__PURE__ */ jsx5("span", { style: { fontSize: 14, fontWeight: 700, color: "#0F172A" }, children: m.name }),
            /* @__PURE__ */ jsx5(Badge, { kind: grKind, children: gr })
          ] }),
          /* @__PURE__ */ jsxs5("div", { style: { display: "flex", alignItems: "baseline", gap: 4, margin: "10px 0" }, children: [
            /* @__PURE__ */ jsx5("span", { style: { fontSize: 30, fontWeight: 800, color: m.color, fontVariantNumeric: "tabular-nums" }, children: score }),
            /* @__PURE__ */ jsxs5("span", { style: { fontSize: 12, color: "#94A3B8" }, children: [
              "/ ",
              m.range[0],
              "\u2013",
          ...
          /* @__PURE__ */ jsxs5("div", { style: { fontSize: 12, color: "#475569", lineHeight: 1.6 }, children: [
            /* @__PURE__ */ jsxs5("div", { children: [
              "\u7B97\u6CD5\uFF1A",
              m.algoType,
              " \xB7 ",
            ...
            /* @__PURE__ */ jsxs5("div", { style: { color: "#94A3B8" }, children: [
              "\u5EFA\u8BAE\uFF1A",
              thr?.action ?? "\u2014"
            ] })
          ] })
      ...
      /* @__PURE__ */ jsx5(Panel, { title: "\u9884\u8B66\u8BB0\u5F55", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u8BE5\u4F01\u4E1A\u8FD1\u671F\u9884\u8B66 \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "enterpriseData.json.alerts" })
      ...
      /* @__PURE__ */ jsx5(Panel, { title: "\u98CE\u9669\u547D\u4E2D\u7EF4\u5EA6", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u7ECF\u8425/\u53F8\u6CD5/\u8206\u60C5\u7B49\u98CE\u9669\u7EF4\u5EA6 \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.riskCounts" })
      ] }), children: /* @__PURE__ */ jsx5("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 8 }, children: cur.riskCounts.map((r) => /* @__PURE__ */ jsxs5("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", border: "1px solid #F1F5F9", borderRadius: 8, padding: "8px 12px", fontSize: 13 }, children: [
        /* @__PURE__ */ jsx5("span", { style: { color: "#475569" }, children: r.name }),
        /* @__PURE__ */ jsxs5("span", { style: { color: r.danger && r.count > 0 ? "#DC2626" : "#059669", fontWeight: 600 }, children: [
    ...
    tab === "\u57FA\u672C\u4FE1\u606F" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u80A1\u4E1C\u4EBA\u6570", value: String(cur.shareholders.length), accent: "brand", hint: /* @__PURE__ */ jsx5(Sam, { label: "\u6837\u4F8B" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u4E3B\u8981\u4EBA\u5458", value: String(cur.persons.length), accent: "cyan", hint: /* @__PURE__ */ jsx5(Sam, { label: "\u6837\u4F8B" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u5BF9\u5916\u6295\u8D44", value: String(cur.invests.length), accent: "violet", hint: /* @__PURE__ */ jsx5(Sam, { label: "\u6837\u4F8B" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u5206\u652F\u673A\u6784", value: String(cur.branches.length), accent: "emerald", hint: /* @__PURE__ */ jsx5(Sam, { label: "\u6837\u4F8B" }) })
      ] }),
      /* @__PURE__ */ jsxs5(Panel, { title: "\u5DE5\u5546\u4FE1\u606F", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u57FA\u7840\u767B\u8BB0\u4FE1\u606F \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json" })
      ] }), children: [
        /* @__PURE__ */ jsx5("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px 24px", fontSize: 13 }, children: [
        ...
        /* @__PURE__ */ jsxs5("div", { style: { marginTop: 10, fontSize: 12, color: "#64748B" }, children: [
          "\u7ECF\u8425\u8303\u56F4\uFF1A",
          cur.bizScope
        ] })
      ] }),
      /* @__PURE__ */ jsx5(Panel, { title: "\u80A1\u4E1C\u4FE1\u606F", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u80A1\u4E1C\u53CA\u51FA\u8D44 \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.shareholders" })
      ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: shCols, rows: shRows, empty: "\u65E0", pager: true, defaultPageSize: 10 }) }),
      /* @__PURE__ */ jsx5(Panel, { title: "\u4E3B\u8981\u4EBA\u5458", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u8463\u76D1\u9AD8 \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.persons" })
      ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: psCols, rows: psRows, empty: "\u65E0", pager: true, defaultPageSize: 10 }) }),
      /* @__PURE__ */ jsx5(Panel, { title: "\u5BF9\u5916\u6295\u8D44", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u88AB\u6295\u8D44\u4F01\u4E1A\u4E0E\u6301\u80A1\u6BD4\u4F8B \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.invests" })
      ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: invCols, rows: invRows, empty: "\u65E0", pager: true, defaultPageSize: 10 }) }),
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginTop: 12 }, children: [
        /* @__PURE__ */ jsx5(Panel, { title: "\u53D8\u66F4\u8BB0\u5F55", desc: /* @__PURE__ */ jsxs5("span", { children: [
          "\u5DE5\u5546\u53D8\u66F4 \xB7 ",
          /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.changes" })
        ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: chCols, rows: chRows, empty: "\u65E0", pager: true, defaultPageSize: 6 }) }),
        /* @__PURE__ */ jsx5(Panel, { title: "\u5206\u652F\u673A\u6784", desc: /* @__PURE__ */ jsxs5("span", { children: [
          "\u5206\u516C\u53F8 \xB7 ",
          /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.branches" })
        ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: brCols, rows: brRows, empty: "\u65E0", pager: true, defaultPageSize: 6 }) })
      ] })
    ] }),
    tab === "\u6CD5\u5F8B\u8BC9\u8BBC" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u53F8\u6CD5\u6848\u4EF6", value: String(riskCases), accent: "rose", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u88C1\u5224\u6587\u4E66", value: String(cur.legalCases.length), accent: "amber", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u7ACB\u6848\u4FE1\u606F", value: "99", accent: "amber", hint: "\u6848\u4EF6\u91CF\u7EA7" }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u5F00\u5EAD\u516C\u544A", value: "119", accent: "cyan", hint: "\u6848\u4EF6\u91CF\u7EA7" })
      ] }),
      /* @__PURE__ */ jsx5(Panel, { title: "\u53F8\u6CD5\u6848\u4EF6", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u4F01\u4E1A\u6D89\u8BC9\u8BB0\u5F55\uFF08\u62BD\u6837\uFF09 \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.legalCases" })
      ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: caseCols, rows: caseRows, empty: "\u65E0\u6D89\u8BC9\u8BB0\u5F55", pager: true, defaultPageSize: 10 }) })
    ] }),
    tab === "\u7ECF\u8425\u98CE\u9669" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u98CE\u9669\u5B50\u9879", value: String(cur.riskCounts.length), accent: "brand", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u98CE\u9669\u547D\u4E2D", value: String(dangerCount), accent: "rose", hint: "\u9700\u5173\u6CE8\u9879" }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u884C\u653F\u5904\u7F5A", value: String(cur.riskCounts.find((r) => r.name === "\u884C\u653F\u5904\u7F5A")?.count ?? 0), accent: "emerald", hint: "\u7EFF\u8272\u4E3A\u65E0" }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u52B3\u52A8\u4EF2\u88C1", value: String(cur.riskCounts.find((r) => r.name === "\u52B3\u52A8\u4EF2\u88C1")?.count ?? 0), accent: "amber", hint: "\u4E89\u8BAE\u9879" })
      ] }),
      /* @__PURE__ */ jsx5(CountGrid, { title: "\u7ECF\u8425\u98CE\u9669", items: cur.riskCounts })
    ] }),
    tab === "\u7ECF\u8425\u4FE1\u606F" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u8D44\u8D28\u8BC1\u4E66", value: String(cur.bizCounts.find((r) => r.name === "\u8D44\u8D28\u8BC1\u4E66")?.count ?? 0), accent: "brand", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u884C\u653F\u8BB8\u53EF", value: String(cur.bizCounts.find((r) => r.name === "\u884C\u653F\u8BB8\u53EF")?.count ?? 0), accent: "cyan", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u62DB\u6295\u6807", value: String(cur.bizCounts.find((r) => r.name === "\u62DB\u6295\u6807")?.count ?? 0), accent: "violet", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u62DB\u8058", value: String(cur.bizCounts.find((r) => r.name === "\u62DB\u8058")?.count ?? 0), accent: "emerald", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) })
      ] }),
      /* @__PURE__ */ jsx5(CountGrid, { title: "\u7ECF\u8425\u4FE1\u606F", items: cur.bizCounts })
    ] }),
    tab === "\u4F01\u4E1A\u53D1\u5C55" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u65B0\u95FB\u8206\u60C5", value: String(cur.newsCount), accent: "brand", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u4E0A\u699C\u699C\u5355", value: String(cur.devCounts.find((r) => r.name === "\u4E0A\u699C\u699C\u5355")?.count ?? 0), accent: "violet", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u8363\u8A89", value: String(cur.devCounts.find((r) => r.name === "\u8363\u8A89")?.count ?? 0), accent: "amber", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u76F8\u5173\u516C\u544A", value: String(cur.devCounts.find((r) => r.name === "\u76F8\u5173\u516C\u544A")?.count ?? 0), accent: "cyan", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) })
      ] }),
      /* @__PURE__ */ jsx5(CountGrid, { title: "\u4F01\u4E1A\u53D1\u5C55", items: cur.devCounts })
    ] }),
    tab === "\u77E5\u8BC6\u4EA7\u6743" && /* @__PURE__ */ jsxs5(Fragment6, { children: [
      /* @__PURE__ */ jsxs5("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx5(StatCard, { label: "\u5546\u6807\u4FE1\u606F", value: String(cur.ipCounts.find((r) => r.name === "\u5546\u6807\u4FE1\u606F")?.count ?? 0), accent: "brand", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u4E13\u5229\u4FE1\u606F", value: String(cur.ipCounts.find((r) => r.name === "\u4E13\u5229\u4FE1\u606F")?.count ?? 0), accent: "violet", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u8F6F\u4EF6\u8457\u4F5C\u6743", value: String(cur.ipCounts.find((r) => r.name === "\u8F6F\u4EF6\u8457\u4F5C\u6743")?.count ?? 0), accent: "cyan", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) }),
        /* @__PURE__ */ jsx5(StatCard, { label: "\u6807\u51C6\u4FE1\u606F", value: String(cur.ipCounts.find((r) => r.name === "\u6807\u51C6\u4FE1\u606F")?.count ?? 0), accent: "emerald", hint: /* @__PURE__ */ jsx5(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }) })
      ] }),
      /* @__PURE__ */ jsx5(CountGrid, { title: "\u77E5\u8BC6\u4EA7\u6743", items: cur.ipCounts }),
      /* @__PURE__ */ jsx5(Panel, { title: "\u5546\u6807 / \u4E13\u5229 / \u8457\u4F5C\u6743\uFF08\u62BD\u6837\uFF09", desc: /* @__PURE__ */ jsxs5("span", { children: [
        "\u77E5\u8BC6\u4EA7\u6743\u660E\u7EC6 \xB7 ",
        /* @__PURE__ */ jsx5(Sam, { value: "qiyeData.json.ips" })
      ] }), children: /* @__PURE__ */ jsx5(DataTable, { columns: ipCols, rows: ipRows, empty: "\u65E0", pager: true, defaultPageSize: 10 }) })
    ] })
  ] });
}
...
function useFlowsVersion() {
  return useSyncExternalStore4(subscribe2, getSnapshot);
}
function useFlows() {
  useFlowsVersion();
  return flows;
...
function FlowConfirmModal({
  ...
  const [opinion, setOpinion] = useState6("");
  const [lastOpen, setLastOpen] = useState6(open);
  if (open !== lastOpen) {
    setLastOpen(open);
    if (open) setOpinion("");
  }
  return /* @__PURE__ */ jsx6(
    Modal,
    {
      ...
      onClose,
      zIndex: 200,
      footer: /* @__PURE__ */ jsxs6(Fragment7, { children: [
...
// src/console/FlowStateCell.tsx
import { Fragment as Fragment8, jsx as jsx7, jsxs as jsxs7 } from "react/jsx-runtime";
function FlowStateCell({ flowId, state, onChange, buttonOnly = false, matchObj }) {
  ...
  if (!f) return /* @__PURE__ */ jsx7("span", { style: { color: "#CBD5E1" }, children: "\u2014" });
  if (!steps.length) return /* @__PURE__ */ jsx7("span", { style: { color: "#CBD5E1" }, children: "\u2014" });
  const { state: st, step } = flowStepOf({ flowSteps: steps, flowState: state });
  const sc = step?.color ?? stepColorOf(st);
  if (buttonOnly) {
    if (!step?.next || !onChange) return /* @__PURE__ */ jsx7("span", { style: { color: "#CBD5E1" }, children: "\u2014" });
  ...
  return /* @__PURE__ */ jsxs7(Fragment8, { children: [
    /* @__PURE__ */ jsxs7("div", { style: { display: "inline-flex", alignItems: "center", gap: 5, background: "#F8FAFC", border: "1px solid #E2E8F0", borderRadius: 6, padding: "2px 6px", whiteSpace: "nowrap" }, children: [
      /* @__PURE__ */ jsx7("span", { style: { fontSize: 12, fontWeight: 600, color: sc }, children: st }),
      step?.next && onChange && /* @__PURE__ */ jsx7(
        "button",
        {
          type: "button",
          onClick: () => setConfirm({ f, step }),
...
var DASH = /* @__PURE__ */ jsx9("span", { style: { color: "#94A3B8" }, children: "\u2014" });
function renderCountdown(opts) {
  ...
  if (remain <= 0) return /* @__PURE__ */ jsx9("span", { style: { color: "#DC2626", fontWeight: 600 }, children: "\u5DF2\u8D85\u65F6" });
  ...
  return /* @__PURE__ */ jsx9("span", { style: { color, fontWeight: 600, fontVariantNumeric: "tabular-nums" }, children: h > 0 ? `${h}\u5C0F\u65F6${m}\u5206` : `${m}\u5206\u949F` });
}
var nowStamp = () => (/* @__PURE__ */ new Date()).toISOString().slice(0, 19).replace("T", " ");

// src/console/EnterprisePages.tsx
import { Fragment as Fragment9, jsx as jsx10, jsxs as jsxs9 } from "react/jsx-runtime";
var CRUMB2 = "\u4F01\u4E1A\u98CE\u63A7";
var ENT_KIND = {
  \u9AD8: "red",
  \u4E2D: "amber",
...
var LIST_LABEL = { black: "\u9ED1\u540D\u5355", white: "\u767D\u540D\u5355", gray: "\u7070\u540D\u5355" };
var DS_KIND = {
  \u5DF2\u63A5\u5165: "green",
  \u672A\u63A5\u5165: "gray",
  \u6D4B\u8BD5\u4E2D: "amber"
...
function EntQuickSearch() {
  return /* @__PURE__ */ jsx10(QiyeSearch, {});
}
function EntRiskProfile() {
  return /* @__PURE__ */ jsx10(QiyeProfile, {});
}
function EntBatchDue() {
  const ent = useEnterpriseData();
  const nav = useNavigate();
  const [newOpen, setNewOpen] = useState10(false);
  const [draft, setDraft] = useState10({ name: "", source: "\u4E0A\u4F20\u540D\u5355" });
  const openTask = (id) => nav(`/console/ep/batch-due-detail?taskId=${encodeURIComponent(id)}`);
  const rows = ent.dueTasks.map((t) => ({
    id: t.id,
    id2: t.id,
    name: t.name,
  ...
  const doCreate = () => {
    ...
    updateEnterpriseData((d) => ({
      ...d,
      dueTasks: [{
        id: `DT-2608-${Date.now().toString(36).toUpperCase()}`,
        ...
        progress: 0,
        hitRisk: 0,
        startedAt: (/* @__PURE__ */ new Date()).toLocaleString("zh-CN", { hour12: false }),
        createdBy: "\u5F53\u524D\u7528\u6237"
      }, ...d.dueTasks]
    }));
    setNewOpen(false);
    setDraft({ name: "", source: "\u4E0A\u4F20\u540D\u5355" });
  };
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      PageShell,
      {
        title: "\u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1",
        crumb: `${CRUMB2} / \u4F01\u4E1A\u98CE\u9669\u5C3D\u8C03\u4E2D\u5FC3 / \u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1`,
        subtitle: "\u4E0A\u4F20\u4F01\u4E1A\u540D\u5355\u6279\u91CF\u67E5\u8BE2\u98CE\u9669\uFF0C\u8DDF\u8E2A\u4EFB\u52A1\u8FDB\u5EA6\u4E0E\u547D\u4E2D\u7ED3\u679C",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.dueTasks" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" }),
          /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "primary", onClick: () => setNewOpen(true), children: "\uFF0B \u65B0\u5EFA\u5C3D\u8C03\u4EFB\u52A1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u4EFB\u52A1\u603B\u6570", value: String(ent.dueTasks.length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u8FDB\u884C\u4E2D", value: String(ent.dueTasks.filter((t) => t.status === "\u8FDB\u884C\u4E2D").length), accent: "amber" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5DF2\u5B8C\u6210", value: String(ent.dueTasks.filter((t) => t.status === "\u5DF2\u5B8C\u6210").length), accent: "emerald" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u7D2F\u8BA1\u547D\u4E2D\u98CE\u9669", value: String(ent.dueTasks.reduce((s, t) => s + t.hitRisk, 0)), accent: "rose" })
    ] }),
    /* @__PURE__ */ jsx10(Panel, { title: "\u5C3D\u8C03\u4EFB\u52A1\u5217\u8868", desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1\u4E0E\u8FDB\u5EA6 \xB7 ",
      /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json" })
      ...
      DataTable,
      {
        ...
        pager: true,
        defaultPageSize: 10,
        actions: (r) => /* @__PURE__ */ jsx10("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: /* @__PURE__ */ jsx10(
          "button",
          {
            type: "button",
            onClick: () => openTask(String(r.id)),
    ...
    /* @__PURE__ */ jsxs9(Modal, { open: newOpen, onClose: () => setNewOpen(false), title: "\u65B0\u5EFA\u5C3D\u8C03\u4EFB\u52A1", children: [
      /* @__PURE__ */ jsxs9("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxs9("label", { className: "block", children: [
          /* @__PURE__ */ jsx10("span", { className: "mb-1 block text-xs text-slate-400", children: "\u4EFB\u52A1\u540D\u79F0" }),
          /* @__PURE__ */ jsx10("input", { value: draft.name, onChange: (e) => setDraft({ ...draft, name: e.target.value }), className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400" })
        ] }),
        /* @__PURE__ */ jsxs9("label", { className: "block", children: [
          /* @__PURE__ */ jsx10("span", { className: "mb-1 block text-xs text-slate-400", children: "\u6765\u6E90" }),
          /* @__PURE__ */ jsxs9("select", { value: draft.source, onChange: (e) => setDraft({ ...draft, source: e.target.value }), className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400", children: [
            /* @__PURE__ */ jsx10("option", { value: "\u4E0A\u4F20\u540D\u5355", children: "\u4E0A\u4F20\u540D\u5355" }),
            /* @__PURE__ */ jsx10("option", { value: "\u63A5\u53E3\u5BFC\u5165", children: "\u63A5\u53E3\u5BFC\u5165" }),
            /* @__PURE__ */ jsx10("option", { value: "\u624B\u5DE5\u5F55\u5165", children: "\u624B\u5DE5\u5F55\u5165" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs9("div", { className: "mt-4 flex justify-end gap-2", children: [
        /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "ghost", onClick: () => setNewOpen(false), children: "\u53D6\u6D88" }),
        /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "primary", onClick: doCreate, children: "\u786E\u8BA4\u521B\u5EFA" })
      ] })
    ] })
  ] });
}
function EntBatchDueDetail() {
  const ent = useEnterpriseData();
  const nav = useNavigate();
  const [params] = useNavParams();
  const task = ent.dueTasks.find((t) => t.id === (params.get("taskId") ?? "")) ?? ent.dueTasks[0];
  if (!task) return /* @__PURE__ */ jsx10("div", { style: { padding: 24 }, children: /* @__PURE__ */ jsx10(PageShell, { title: "\u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1\u8BE6\u60C5", crumb: `${CRUMB2} / \u4F01\u4E1A\u98CE\u9669\u5C3D\u8C03\u4E2D\u5FC3 / \u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1`, subtitle: "\u672A\u627E\u5230\u4EFB\u52A1" }) });
  const meta = {
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1\u8BE6\u60C5",
        crumb: `${CRUMB2} / \u4F01\u4E1A\u98CE\u9669\u5C3D\u8C03\u4E2D\u5FC3 / \u6279\u91CF\u5C3D\u8C03\u4EFB\u52A1 / ${task.name}`,
        subtitle: "\u4EFB\u52A1\u8FDB\u5EA6\u76D1\u63A7\u4E0E\u547D\u4E2D\u98CE\u9669\u4F01\u4E1A\u660E\u7EC6",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.dueTasks" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u8BA1\u7B97" }),
          /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "secondary", onClick: () => nav("/console/ep/batch-due"), children: "\u2190 \u8FD4\u56DE\u4EFB\u52A1\u5217\u8868" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u4EFB\u52A1\u72B6\u6001", value: task.status, accent: task.status === "\u5DF2\u5B8C\u6210" ? "emerald" : task.status === "\u5931\u8D25" ? "rose" : task.status === "\u8FDB\u884C\u4E2D" ? "amber" : "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u4F01\u4E1A\u603B\u6570", value: String(task.count), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u547D\u4E2D\u98CE\u9669", value: String(task.hitRisk), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u521B\u5EFA\u4EBA", value: task.createdBy, accent: "cyan" })
    ] }),
    /* @__PURE__ */ jsxs9(Panel, { title: "\u4EFB\u52A1\u8FDB\u5EA6", desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u6279\u91CF\u5C3D\u8C03\u6267\u884C\u8FDB\u5EA6 \xB7 ",
      /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u8BA1\u7B97" })
    ] }), children: [
      /* @__PURE__ */ jsxs9("div", { style: { display: "flex", alignItems: "center", gap: 16 }, children: [
        /* @__PURE__ */ jsxs9("div", { style: { flex: 1 }, children: [
          /* @__PURE__ */ jsxs9("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: 8 }, children: [
            /* @__PURE__ */ jsx10("span", { style: { fontSize: 13, color: "#475569" }, children: task.status === "\u8FDB\u884C\u4E2D" ? "\u6279\u91CF\u67E5\u8BE2\u6267\u884C\u4E2D" : task.status === "\u5DF2\u5B8C\u6210" ? "\u4EFB\u52A1\u5DF2\u5B8C\u6210" : task.status === "\u5931\u8D25" ? "\u4EFB\u52A1\u6267\u884C\u5931\u8D25" : "\u4EFB\u52A1\u5F85\u5F00\u59CB" }),
            /* @__PURE__ */ jsxs9("span", { style: { fontSize: 13, fontWeight: 700, color: m.color }, children: [
              task.progress,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsx10("div", { style: { height: 12, borderRadius: 6, background: "#F1F5F9", overflow: "hidden" }, children: /* @__PURE__ */ jsx10("div", { style: { width: `${task.progress}%`, height: "100%", borderRadius: 6, background: m.color } }) })
        ] }),
        /* @__PURE__ */ jsxs9("div", { style: { fontSize: 11, color: "#94A3B8", textAlign: "right" }, children: [
          /* @__PURE__ */ jsxs9("div", { children: [
            "\u5F00\u59CB\uFF1A",
            task.startedAt
          ] }),
          task.finishedAt && /* @__PURE__ */ jsxs9("div", { children: [
            "\u5B8C\u6210\uFF1A",
            task.finishedAt
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx10("div", { style: { display: "flex", gap: 8, marginTop: 14, flexWrap: "wrap" }, children: ["\u4F01\u4E1A\u540D\u5355\u89E3\u6790", "\u5DE5\u5546\u6838\u9A8C", "\u53F8\u6CD5\u6D89\u8BC9", "\u7ECF\u8425/\u8D22\u52A1", "\u8206\u60C5\u76D1\u6D4B", "\u98CE\u9669\u6C47\u603B"].map((s, i) => {
        const done = task.progress >= (i + 1) / 6 * 100 || task.status === "\u5DF2\u5B8C\u6210";
        return /* @__PURE__ */ jsxs9("span", { style: { fontSize: 11, padding: "4px 10px", borderRadius: 999, background: done ? "#D1FAE5" : "#F1F5F9", color: done ? "#059669" : "#94A3B8", border: `1px solid ${done ? "#A7F3D0" : "#E2E8F0"}` }, children: [
          done ? "\u2713 " : "",
          s
        ] }, s);
      }) })
    ] }),
    /* @__PURE__ */ jsx10(Panel, { title: "\u547D\u4E2D\u98CE\u9669\u4F01\u4E1A", desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u8BE5\u4EFB\u52A1\u547D\u4E2D\u98CE\u9669\u4FE1\u53F7\u7684\u4F01\u4E1A\u660E\u7EC6 \xB7 ",
      /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.monitorList" })
    ] }), children: /* @__PURE__ */ jsx10(DataTable, { columns: cols, rows, empty: "\u6682\u65E0\u547D\u4E2D\u98CE\u9669\u4F01\u4E1A", pager: true, defaultPageSize: 8 }) })
  ] });
}
function EntMonitorList() {
  const ent = useEnterpriseData();
  const nav = useNavigate();
  const rows = ent.monitorList.map((m) => ({
    id: m.keyNo,
    name: m.name,
    industry: m.industry,
    riskLevel: { v: m.riskLevel, kind: ENT_KIND[m.riskLevel] },
    monitorSince: m.monitorSince,
    alerts: String(m.alerts),
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u5B58\u91CF\u4F01\u4E1A\u76D1\u63A7\u540D\u5355",
        crumb: `${CRUMB2} / \u4F01\u4E1A\u98CE\u9669\u5C3D\u8C03\u4E2D\u5FC3 / \u5B58\u91CF\u4F01\u4E1A\u76D1\u63A7\u540D\u5355`,
    ...
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u76D1\u63A7\u4E2D\u4F01\u4E1A", value: String(ent.monitorList.filter((m) => m.status === "\u76D1\u63A7\u4E2D").length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u9AD8\u98CE\u9669", value: String(ent.monitorList.filter((m) => m.riskLevel === "\u9AD8").length), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u4E2D\u98CE\u9669", value: String(ent.monitorList.filter((m) => m.riskLevel === "\u4E2D").length), accent: "amber" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u7D2F\u8BA1\u9884\u8B66", value: String(ent.monitorList.reduce((s, m) => s + m.alerts, 0)), accent: "violet" })
    ] }),
    /* @__PURE__ */ jsx10(Panel, { title: "\u76D1\u63A7\u540D\u5355", desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u5B58\u91CF\u4F01\u4E1A\u76D1\u63A7 \xB7 ",
      /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json" })
    ] }), children: /* @__PURE__ */ jsx10(
      DataTable,
      {
        ...
        actions: (r) => {
          ...
          return /* @__PURE__ */ jsx10("div", { style: { display: "flex", gap: 6 }, children: /* @__PURE__ */ jsx10(
            "button",
            {
              type: "button",
              onClick: () => {
                if (m) {
                  setQiyeSelected(m.name, m.keyNo);
                  nav("/console/ep/qiye-profile");
                }
              },
              style: { padding: "3px 12px", borderRadius: 6, border: "1px solid #C7D2FE", background: "#EFF6FF", color: "#1D4ED8", fontSize: 12, cursor: "pointer" },
...
function EntDecisionEvents() {
  ...
  const rows = filtered.map((d) => ({
    ...
    result: { v: d.result, kind: d.result === "\u62D2\u7EDD" ? "red" : d.result === "\u901A\u8FC7" ? "green" : d.result === "\u8F6C\u4EBA\u5DE5" ? "amber" : "violet" },
    level: { v: d.level, kind: ENT_KIND[d.level] },
    status: { v: d.status, kind: d.status === "\u5F85\u590D\u6838" ? "red" : d.status === "\u590D\u6838\u4E2D" ? "amber" : "green" },
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u51B3\u7B56\u4E8B\u4EF6\u5217\u8868",
        crumb: `${CRUMB2} / \u98CE\u9669\u4E8B\u4EF6\u7BA1\u7406 / \u51B3\u7B56\u4E8B\u4EF6\u5217\u8868`,
        subtitle: "\u4F01\u4E1A\u6388\u4FE1 / \u5C3D\u8C03 / \u540D\u5355 / \u9884\u8B66\u5904\u7F6E\u7B49\u51B3\u7B56\u4E8B\u4EF6\u5217\u8868\uFF0C\u53EF\u8FFD\u8E2A\u51B3\u7B56\u8FC7\u7A0B",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.decisionEvents" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u51B3\u7B56\u4E8B\u4EF6", value: String(ent.decisionEvents.length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u901A\u8FC7", value: String(ent.decisionEvents.filter((d) => d.result === "\u901A\u8FC7").length), accent: "emerald" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u62D2\u7EDD", value: String(ent.decisionEvents.filter((d) => d.result === "\u62D2\u7EDD").length), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u8F6C\u4EBA\u5DE5", value: String(ent.decisionEvents.filter((d) => d.result === "\u8F6C\u4EBA\u5DE5").length), accent: "amber" })
    ] }),
    /* @__PURE__ */ jsx10(
      Panel,
      {
        title: "\u51B3\u7B56\u4E8B\u4EF6",
        desc: /* @__PURE__ */ jsxs9("span", { children: [
          "\u51B3\u7B56\u4E8B\u4EF6\u961F\u5217 \xB7 ",
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u8FC7\u6EE4" })
        ] }),
        actions: /* @__PURE__ */ jsxs9("select", { value: result, onChange: (e) => setResult(e.target.value), style: { padding: "4px 8px", borderRadius: 6, border: "1px solid #E2E8F0", fontSize: 12, background: "#fff" }, children: [
          /* @__PURE__ */ jsx10("option", { value: "", children: "\u5168\u90E8\u7ED3\u679C" }),
          /* @__PURE__ */ jsx10("option", { value: "\u901A\u8FC7", children: "\u901A\u8FC7" }),
          /* @__PURE__ */ jsx10("option", { value: "\u62D2\u7EDD", children: "\u62D2\u7EDD" }),
          /* @__PURE__ */ jsx10("option", { value: "\u8F6C\u4EBA\u5DE5", children: "\u8F6C\u4EBA\u5DE5" }),
          /* @__PURE__ */ jsx10("option", { value: "\u9884\u8B66", children: "\u9884\u8B66" })
        ] }),
        children: /* @__PURE__ */ jsx10(
          DataTable,
          {
            ...
            pager: true,
            defaultPageSize: 10,
            actions: (r) => /* @__PURE__ */ jsx10(
              "button",
              {
                type: "button",
                onClick: () => nav("/console/ep/decision-trace?id=" + String(r.id)),
                style: { padding: "3px 12px", borderRadius: 6, border: "1px solid #C7D2FE", background: "#EFF6FF", color: "#1D4ED8", fontSize: 12, cursor: "pointer" },
                children: "\u8FFD\u8E2A \u2192"
              }
            )
...
function EntReviewOrders() {
  const ent = useEnterpriseData();
  const [st, setSt] = useState10("");
  ...
  const rows = filtered.map((o) => ({
    ...
    entName: o.entName,
    reason: o.reason,
    level: { v: o.level, kind: ENT_KIND[o.level] },
    status: { v: o.status, kind: ORDER_KIND[o.status] },
    assignee: o.assignee,
  ...
  const review = (id, ok) => updateEnterpriseData((d) => ({
    ...d,
    reviewOrders: d.reviewOrders.map((o) => o.id === id ? { ...o, status: ok ? "\u5DF2\u590D\u6838" : "\u5DF2\u9A73\u56DE", conclusion: ok ? "\u590D\u6838\u901A\u8FC7\uFF0C\u540C\u610F\u539F\u51B3\u7B56" : "\u590D\u6838\u9A73\u56DE\uFF0C\u91CD\u65B0\u8BC4\u4F30", reviewer: "\u5F53\u524D\u7528\u6237", reviewedAt: (/* @__PURE__ */ new Date()).toLocaleString("zh-CN", { hour12: false }) } : o)
  }));
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      PageShell,
      {
        title: "\u4EBA\u5DE5\u590D\u6838\u5DE5\u5355",
        crumb: `${CRUMB2} / \u98CE\u9669\u4E8B\u4EF6\u7BA1\u7406 / \u4EBA\u5DE5\u590D\u6838\u5DE5\u5355`,
        subtitle: "\u9700\u4EBA\u5DE5\u590D\u6838\u7684\u51B3\u7B56\u5DE5\u5355\uFF1A\u5F85\u590D\u6838 / \u590D\u6838\u4E2D / \u5DF2\u590D\u6838\u961F\u5217",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.reviewOrders" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5DE5\u5355\u603B\u6570", value: String(ent.reviewOrders.length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5F85\u590D\u6838", value: String(ent.reviewOrders.filter((o) => o.status === "\u5F85\u590D\u6838").length), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u590D\u6838\u4E2D", value: String(ent.reviewOrders.filter((o) => o.status === "\u590D\u6838\u4E2D").length), accent: "amber" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5DF2\u590D\u6838", value: String(ent.reviewOrders.filter((o) => o.status === "\u5DF2\u590D\u6838").length), accent: "emerald" })
    ] }),
    /* @__PURE__ */ jsx10(
      Panel,
      {
        ...
        actions: /* @__PURE__ */ jsxs9("select", { value: st, onChange: (e) => setSt(e.target.value), style: { padding: "4px 8px", borderRadius: 6, border: "1px solid #E2E8F0", fontSize: 12, background: "#fff" }, children: [
          /* @__PURE__ */ jsx10("option", { value: "", children: "\u5168\u90E8\u72B6\u6001" }),
          /* @__PURE__ */ jsx10("option", { value: "\u5F85\u590D\u6838", children: "\u5F85\u590D\u6838" }),
          /* @__PURE__ */ jsx10("option", { value: "\u590D\u6838\u4E2D", children: "\u590D\u6838\u4E2D" }),
          /* @__PURE__ */ jsx10("option", { value: "\u5DF2\u590D\u6838", children: "\u5DF2\u590D\u6838" }),
          /* @__PURE__ */ jsx10("option", { value: "\u5DF2\u9A73\u56DE", children: "\u5DF2\u9A73\u56DE" })
        ] }),
        children: /* @__PURE__ */ jsx10(
          DataTable,
          {
            ...
            pager: true,
            defaultPageSize: 10,
            actions: (r) => String(r.status) === "\u5DF2\u590D\u6838" || String(r.status) === "\u5DF2\u9A73\u56DE" ? null : /* @__PURE__ */ jsxs9("div", { style: { display: "flex", gap: 6 }, children: [
              /* @__PURE__ */ jsx10("button", { type: "button", onClick: () => review(String(r.id), true), style: { padding: "3px 10px", borderRadius: 6, border: "1px solid #A7F3D0", background: "#ECFDF5", color: "#059669", fontSize: 12, cursor: "pointer" }, children: "\u901A\u8FC7" }),
              /* @__PURE__ */ jsx10("button", { type: "button", onClick: () => review(String(r.id), false), style: { padding: "3px 10px", borderRadius: 6, border: "1px solid #FECACA", background: "#FEF2F2", color: "#DC2626", fontSize: 12, cursor: "pointer" }, children: "\u9A73\u56DE" })
            ] })
          }
        )
      }
...
function EntModelList() {
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u6A21\u578B\u5217\u8868",
        crumb: `${CRUMB2} / \u6A21\u578B\u7BA1\u7406\u4E2D\u5FC3 / \u6A21\u578B\u5217\u8868`,
        subtitle: "\u4F01\u4E1A\u98CE\u63A7\u6A21\u578B\uFF1A\u4F01\u4E1A\u8FDD\u7EA6\u5206 / \u6B3A\u8BC8\u5206 / \u5173\u8054\u98CE\u9669\u5206\uFF0C\u70B9\u51FB\u5361\u7247\u8FDB\u5165\u6A21\u578B\u8BE6\u60C5",
        actions: /* @__PURE__ */ jsx10(Fragment9, { children: /* @__PURE__ */ jsx10(Cfg, { value: "enterpriseData.json.models" }) })
      }
    ),
    /* @__PURE__ */ jsx10("div", { className: "grid grid-cols-1 gap-4 md:grid-cols-3", children: ent.models.map((m) => /* @__PURE__ */ jsxs9(
      "button",
      {
        onClick: () => nav("/console/ep/model-list?model=" + m.id),
        ...
        children: [
          /* @__PURE__ */ jsxs9("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxs9("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx10("span", { className: "h-3 w-3 rounded-full", style: { background: m.color } }),
              /* @__PURE__ */ jsx10("span", { className: "text-base font-semibold text-ink-900", children: m.name })
            ] }),
            /* @__PURE__ */ jsx10(Badge, { kind: m.enabled ? "green" : "gray", children: m.enabled ? "\u5DF2\u542F\u7528" : "\u5DF2\u505C\u7528" })
          ] }),
          /* @__PURE__ */ jsxs9("div", { className: "mt-3 flex items-end gap-2", children: [
            /* @__PURE__ */ jsx10("span", { className: "text-3xl font-bold tabular-nums", style: { color: m.color }, children: m.score }),
          ...
          /* @__PURE__ */ jsxs9("div", { className: "mt-3 space-y-1 text-sm text-slate-500", children: [
            /* @__PURE__ */ jsxs9("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsx10("span", { children: "\u7B97\u6CD5\u7C7B\u578B" }),
              /* @__PURE__ */ jsx10("span", { className: "text-slate-700", children: m.algoType })
            ] }),
            /* @__PURE__ */ jsxs9("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsx10("span", { children: "\u7248\u672C" }),
              /* @__PURE__ */ jsx10("span", { className: "text-slate-700", children: m.version })
            ] }),
            /* @__PURE__ */ jsxs9("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsx10("span", { children: "\u66F4\u65B0\u65F6\u95F4" }),
              /* @__PURE__ */ jsx10("span", { className: "text-slate-700", children: m.updatedAt })
            ] }),
            /* @__PURE__ */ jsxs9("div", { className: "flex justify-between", children: [
              /* @__PURE__ */ jsx10("span", { children: "\u56E0\u5B50\u6570" }),
              /* @__PURE__ */ jsx10("span", { className: "text-slate-700", children: m.factors.length })
            ] })
          ] }),
          /* @__PURE__ */ jsx10("div", { className: "mt-4 text-right text-sm font-medium text-brand-600 group-hover:underline", children: "\u8FDB\u5165\u8BE6\u60C5 \u2192" })
        ]
      },
      m.id
    )) }),
    /* @__PURE__ */ jsx10("div", { style: { marginTop: 12 }, children: /* @__PURE__ */ jsx10(Panel, { title: "\u8BF4\u660E", actions: /* @__PURE__ */ jsx10(Cfg, { value: "enterpriseData.json.models" }), children: /* @__PURE__ */ jsx10("p", { className: "text-sm text-slate-500", children: "\u4F01\u4E1A\u98CE\u63A7\u6A21\u578B\u53C2\u8003\u8BC4\u5206\u4EA7\u54C1\u6A21\u578B\u5217\u8868\u590D\u7528\uFF0C\u6A21\u578B\u4FE1\u606F\u8C03\u6574\u4E3A\u7B26\u5408\u4F01\u4E1A\u4E1A\u52A1\uFF08\u5DE5\u5546/\u53F8\u6CD5/\u7A0E\u52A1/\u5F81\u4FE1/\u5173\u8054/\u8206\u60C5\u56E0\u5B50\uFF09\u3002\u70B9\u51FB\u5361\u7247\u8FDB\u5165\u6A21\u578B\u8BE6\u60C5\uFF0C\u67E5\u770B\u56E0\u5B50\u6743\u91CD\u3001\u8BC4\u5206\u9608\u503C\u4E0E\u8FD0\u8425\u6548\u679C\u3002" }) }) })
  ] });
}
function EntModelDetail() {
  const ent = useEnterpriseData();
  const [params] = useNavParams();
  const id = params.get("model") ?? "ent-credit";
  const m = ent.models.find((x) => x.id === id) ?? ent.models[0];
  const [tab, setTab] = useState10("base");
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      PageShell,
      {
        title: m.name,
        crumb: `${CRUMB2} / \u6A21\u578B\u7BA1\u7406\u4E2D\u5FC3 / \u6A21\u578B\u5217\u8868 / ${m.name}`,
        subtitle: `${m.desc} \xB7 ${m.version}`,
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Cfg, { value: "enterpriseData.json.models" }),
          /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "secondary", onClick: () => window.history.back(), children: "\u2190 \u8FD4\u56DE\u6A21\u578B\u5217\u8868" })
        ] })
      }
    ),
    /* @__PURE__ */ jsx10("div", { style: { display: "flex", gap: 4, borderBottom: "1px solid #E2E8F0", marginBottom: 14 }, children: [["base", "\u57FA\u672C\u4FE1\u606F"], ["effect", "\u6A21\u578B\u6548\u679C"], ["threshold", "\u8BC4\u5206\u9608\u503C"]].map(([k, l]) => /* @__PURE__ */ jsx10("button", { onClick: () => setTab(k), style: { padding: "8px 14px", fontSize: 13, border: "none", background: "none", cursor: "pointer", color: tab === k ? "#0EA5E9" : "#64748B", fontWeight: tab === k ? 700 : 400, borderBottom: tab === k ? "2px solid #0EA5E9" : "2px solid transparent", marginBottom: -1 }, children: l }, k)) }),
    tab === "base" && /* @__PURE__ */ jsxs9(Fragment9, { children: [
      /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx10(StatCard, { label: "\u5F53\u524D\u5206", value: String(m.score), accent: "brand", hint: `\u533A\u95F4 ${m.range[0]}\u2013${m.range[1]}` }),
        /* @__PURE__ */ jsx10(StatCard, { label: "\u7B97\u6CD5\u7C7B\u578B", value: m.algoType, accent: "cyan" }),
        /* @__PURE__ */ jsx10(StatCard, { label: "\u7248\u672C", value: m.version, accent: "violet" }),
        /* @__PURE__ */ jsx10(StatCard, { label: "\u66F4\u65B0\u65F6\u95F4", value: m.updatedAt, accent: "emerald" })
      ] }),
      /* @__PURE__ */ jsx10(Panel, { title: "\u7279\u5F81\u56E0\u5B50\u6743\u91CD", desc: /* @__PURE__ */ jsxs9("span", { children: [
        "\u6A21\u578B\u7279\u5F81\u4E0E\u6743\u91CD \xB7 ",
        /* @__PURE__ */ jsx10(Cfg, { value: "enterpriseData.json" })
      ] }), children: /* @__PURE__ */ jsx10("div", { className: "space-y-2", children: m.factors.map((f) => /* @__PURE__ */ jsxs9("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsx10("span", { style: { width: 160, fontSize: 13, color: "#475569" }, children: f.name }),
        /* @__PURE__ */ jsx10("div", { style: { flex: 1, height: 8, borderRadius: 4, background: "#F1F5F9", overflow: "hidden" }, children: /* @__PURE__ */ jsx10("div", { style: { width: `${f.weight * 100}%`, height: "100%", background: m.color, borderRadius: 4 } }) }),
        /* @__PURE__ */ jsxs9("span", { style: { width: 50, textAlign: "right", fontSize: 13, fontWeight: 600 }, children: [
          (f.weight * 100).toFixed(0),
          "%"
        ] })
      ] }, f.name)) }) })
    ] }),
    tab === "effect" && /* @__PURE__ */ jsxs9(Fragment9, { children: [
      /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 14 }, children: [
        /* @__PURE__ */ jsx10(StatCard, { label: "\u8986\u76D6\u7387", value: `${m.ops.coverage}%`, accent: "brand" }),
        /* @__PURE__ */ jsx10(StatCard, { label: "\u51C6\u786E\u7387", value: `${m.ops.accuracy}%`, accent: "emerald" }),
        /* @__PURE__ */ jsx10(StatCard, { label: "\u53CA\u65F6\u7387", value: `${m.ops.timely}%`, accent: "amber" }),
        /* @__PURE__ */ jsx10(StatCard, { label: "\u7D2F\u8BA1\u8C03\u7528", value: m.ops.calls.toLocaleString(), accent: "violet" })
      ] }),
      /* @__PURE__ */ jsx10(Panel, { title: "\u8FD0\u8425\u8D8B\u52BF", actions: /* @__PURE__ */ jsx10(Cal, {}), children: /* @__PURE__ */ jsx10(
        LineChart,
        {
          labels: m.ops.trend.map((t) => t.month),
          height: 240,
          series: [
    ...
    tab === "threshold" && /* @__PURE__ */ jsx10(Panel, { title: "\u8BC4\u5206\u9608\u503C", desc: "\u5206\u6570\u533A\u95F4 \u2192 \u7B49\u7EA7 \u2192 \u542B\u4E49 \u2192 \u5EFA\u8BAE\u52A8\u4F5C", actions: /* @__PURE__ */ jsx10(Cfg, { value: "enterpriseData.json" }), children: /* @__PURE__ */ jsx10(DataTable, { columns: [
    ...
    ], rows: m.thresholds.map((t) => ({ id: t.range, range: t.range, level: { v: t.level, kind: ENT_KIND[t.level.split("\u98CE\u9669")[0] ?? "\u4E2D"] ?? "gray" }, meaning: t.meaning, action: t.action })), empty: "\u6682\u65E0\u9608\u503C", pager: true, defaultPageSize: 10 }) })
  ] });
}
...
function EntListManage() {
  const ent = useEnterpriseData();
  const nav = useNavigate();
  const [tab, setTab] = useState10("black");
  ...
  const cnt = (t) => ent.listEnts.filter((l) => l.list === t).length;
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      PageShell,
      {
        ...
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.listEnts" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u9ED1\u540D\u5355", value: String(cnt("black")), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u767D\u540D\u5355", value: String(cnt("white")), accent: "emerald" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u7070\u540D\u5355", value: String(cnt("gray")), accent: "brand" })
    ] }),
    /* @__PURE__ */ jsx10("div", { style: { display: "flex", gap: 4, borderBottom: "1px solid #E2E8F0", marginBottom: 14 }, children: ["black", "white", "gray"].map((t) => /* @__PURE__ */ jsxs9(
      "button",
      {
        onClick: () => setTab(t),
    ...
    /* @__PURE__ */ jsx10(Panel, { title: `${LIST_LABEL[tab]}\u5217\u8868`, desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u540D\u5355\u660E\u7EC6 \xB7 ",
      /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json" })
    ] }), children: /* @__PURE__ */ jsx10(
      DataTable,
...
function EntDataSource() {
  const ent = useEnterpriseData();
  const [dsSel, setDsSel] = useState10(null);
  const rows = ent.dataSources.map((s) => ({
    id: s.id,
    name: s.name,
    category: { v: s.category, kind: "blue" },
    desc: s.desc,
    status: { v: s.status, kind: DS_KIND[s.status] },
    vendor: s.vendor,
    cost: s.cost ?? "\u2014",
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u6570\u636E\u6E90\u5E02\u573A\u4E0E\u7BA1\u7406",
        crumb: `${CRUMB2} / \u6570\u636E\u6E90\u5E02\u573A\u4E0E\u7BA1\u7406`,
        subtitle: "\u4F01\u4E1A\u6570\u636E\u6E90\u5E02\u573A\uFF1A\u5DE5\u5546 / \u53F8\u6CD5 / \u7A0E\u52A1 / \u5F81\u4FE1 / \u8206\u60C5 / \u5173\u8054\u7B49\u6570\u636E\u6E90\u63A5\u5165\u4E0E\u7BA1\u7406",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.dataSources" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u6570\u636E\u6E90\u603B\u6570", value: String(ent.dataSources.length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5DF2\u63A5\u5165", value: String(ent.dataSources.filter((s) => s.status === "\u5DF2\u63A5\u5165").length), accent: "emerald" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u6D4B\u8BD5\u4E2D", value: String(ent.dataSources.filter((s) => s.status === "\u6D4B\u8BD5\u4E2D").length), accent: "amber" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u672A\u63A5\u5165", value: String(ent.dataSources.filter((s) => s.status === "\u672A\u63A5\u5165").length), accent: "brand" })
    ] }),
    /* @__PURE__ */ jsx10(Panel, { title: "\u6570\u636E\u6E90\u5217\u8868", desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u4F01\u4E1A\u6570\u636E\u6E90 \xB7 ",
      /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json" })
    ] }), children: /* @__PURE__ */ jsx10(
      DataTable,
      {
        ...
        actions: (r) => {
          ...
          return /* @__PURE__ */ jsx10(
            ...
            {
              type: "button",
              onClick: () => s && setDsSel({ id: s.id, name: s.name, category: s.category, desc: s.desc, status: s.status, vendor: s.vendor, cost: s.cost, updatedAt: s.updatedAt }),
              style: { padding: "3px 12px", borderRadius: 6, border: "1px solid #C7D2FE", background: "#EFF6FF", color: "#1D4ED8", fontSize: 12, cursor: "pointer" },
              children: "\u67E5\u770B"
            }
          );
    ...
    /* @__PURE__ */ jsxs9(Modal, { open: dsSel != null, onClose: () => setDsSel(null), title: `\u6570\u636E\u6E90\u8BE6\u60C5 \xB7 ${dsSel?.name ?? ""}`, children: [
      dsSel && /* @__PURE__ */ jsxs9("div", { className: "space-y-2 text-sm", children: [
        /* @__PURE__ */ jsxs9("div", { className: "flex justify-between border-b border-slate-50 py-1.5", children: [
          /* @__PURE__ */ jsx10("span", { className: "text-slate-500", children: "\u5206\u7C7B" }),
          /* @__PURE__ */ jsx10("b", { children: dsSel.category })
        ] }),
        /* @__PURE__ */ jsxs9("div", { className: "flex justify-between border-b border-slate-50 py-1.5", children: [
          /* @__PURE__ */ jsx10("span", { className: "text-slate-500", children: "\u63A5\u5165\u72B6\u6001" }),
          /* @__PURE__ */ jsx10("b", { children: dsSel.status })
        ] }),
        /* @__PURE__ */ jsxs9("div", { className: "flex justify-between border-b border-slate-50 py-1.5", children: [
          /* @__PURE__ */ jsx10("span", { className: "text-slate-500", children: "\u4F9B\u5E94\u5546" }),
          /* @__PURE__ */ jsx10("b", { children: dsSel.vendor })
        ] }),
        /* @__PURE__ */ jsxs9("div", { className: "flex justify-between border-b border-slate-50 py-1.5", children: [
          /* @__PURE__ */ jsx10("span", { className: "text-slate-500", children: "\u8BA1\u8D39" }),
          /* @__PURE__ */ jsx10("b", { children: dsSel.cost ?? "\u2014" })
        ] }),
        /* @__PURE__ */ jsxs9("div", { className: "flex justify-between border-b border-slate-50 py-1.5", children: [
          /* @__PURE__ */ jsx10("span", { className: "text-slate-500", children: "\u66F4\u65B0\u65F6\u95F4" }),
          /* @__PURE__ */ jsx10("b", { children: dsSel.updatedAt })
        ] }),
        /* @__PURE__ */ jsxs9("div", { className: "py-1.5", children: [
          /* @__PURE__ */ jsx10("span", { className: "text-slate-500", children: "\u8BF4\u660E" }),
          /* @__PURE__ */ jsx10("p", { className: "mt-1 text-slate-700", children: dsSel.desc })
        ] })
      ] }),
      /* @__PURE__ */ jsx10("div", { className: "mt-4 flex justify-end", children: /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "secondary", onClick: () => setDsSel(null), children: "\u5173\u95ED" }) })
    ] })
  ] });
}
function EntAlertRule() {
  const ent = useEnterpriseData();
  const [newOpen, setNewOpen] = useState10(false);
  const [draft, setDraft] = useState10({ name: "", category: "\u53F8\u6CD5\u6D89\u8BC9", condition: "", level: "\u4E2D", action: "" });
  const toggle = (id) => updateEnterpriseData((d) => ({ ...d, alertRules: d.alertRules.map((r) => r.id === id ? { ...r, enabled: !r.enabled } : r) }));
  const add = () => updateEnterpriseData((d) => ({
    ...d,
    alertRules: [...d.alertRules, { id: `ER-${Date.now().toString(36).toUpperCase()}`, name: draft.name || "\u672A\u547D\u540D\u89C4\u5219", category: draft.category, condition: draft.condition || "\u81EA\u5B9A\u4E49\u6761\u4EF6", level: draft.level, action: draft.action || "\u4EBA\u5DE5\u6838\u5B9E", enabled: true }]
  }));
  const rows = ent.alertRules.map((r) => ({
    id: r.id,
    name: r.name,
    category: { v: r.category, kind: "blue" },
    condition: r.condition,
    level: { v: r.level, kind: ENT_KIND[r.level] },
    action: r.action,
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u9884\u8B66\u89C4\u5219\u914D\u7F6E",
        crumb: `${CRUMB2} / \u98CE\u9669\u9884\u8B66\u4E2D\u5FC3 / \u9884\u8B66\u89C4\u5219\u914D\u7F6E`,
        subtitle: "\u4F01\u4E1A\u98CE\u9669\u9884\u8B66\u89C4\u5219\uFF1A\u53F8\u6CD5\u6D89\u8BC9 / \u7ECF\u8425\u5F02\u5E38 / \u8206\u60C5\u8D1F\u9762 / \u8D22\u52A1\u6076\u5316 / \u5173\u8054\u98CE\u9669\u7B49",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.alertRules" }),
          /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "primary", onClick: () => setNewOpen(true), children: "\uFF0B \u65B0\u589E\u89C4\u5219" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u89C4\u5219\u603B\u6570", value: String(ent.alertRules.length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u542F\u7528", value: String(ent.alertRules.filter((r) => r.enabled).length), accent: "emerald" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u9AD8\u98CE\u9669", value: String(ent.alertRules.filter((r) => r.level === "\u9AD8").length), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5DF2\u505C\u7528", value: String(ent.alertRules.filter((r) => !r.enabled).length), accent: "brand" })
    ] }),
    /* @__PURE__ */ jsx10(Panel, { title: "\u9884\u8B66\u89C4\u5219", desc: /* @__PURE__ */ jsxs9("span", { children: [
      "\u4F01\u4E1A\u9884\u8B66\u89C4\u5219 \xB7 ",
      /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
    ] }), children: /* @__PURE__ */ jsx10(
      DataTable,
      {
        ...
        actions: (r) => {
          ...
          return /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "ghost", onClick: () => toggle(String(r.id)), children: rule?.enabled ? "\u505C\u7528" : "\u542F\u7528" });
        }
      }
    ) }),
    /* @__PURE__ */ jsxs9(Modal, { open: newOpen, onClose: () => setNewOpen(false), title: "\u65B0\u589E\u9884\u8B66\u89C4\u5219", children: [
      /* @__PURE__ */ jsxs9("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsx10("input", { value: draft.name, onChange: (e) => setDraft({ ...draft, name: e.target.value }), placeholder: "\u89C4\u5219\u540D\u79F0", className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400" }),
        /* @__PURE__ */ jsxs9("select", { value: draft.category, onChange: (e) => setDraft({ ...draft, category: e.target.value }), className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400", children: [
          /* @__PURE__ */ jsx10("option", { value: "\u53F8\u6CD5\u6D89\u8BC9", children: "\u53F8\u6CD5\u6D89\u8BC9" }),
          /* @__PURE__ */ jsx10("option", { value: "\u7ECF\u8425\u5F02\u5E38", children: "\u7ECF\u8425\u5F02\u5E38" }),
          /* @__PURE__ */ jsx10("option", { value: "\u8206\u60C5\u8D1F\u9762", children: "\u8206\u60C5\u8D1F\u9762" }),
          /* @__PURE__ */ jsx10("option", { value: "\u8D22\u52A1\u6076\u5316", children: "\u8D22\u52A1\u6076\u5316" }),
          /* @__PURE__ */ jsx10("option", { value: "\u5173\u8054\u98CE\u9669", children: "\u5173\u8054\u98CE\u9669" }),
          /* @__PURE__ */ jsx10("option", { value: "\u7A0E\u52A1", children: "\u7A0E\u52A1" })
        ] }),
        /* @__PURE__ */ jsx10("input", { value: draft.condition, onChange: (e) => setDraft({ ...draft, condition: e.target.value }), placeholder: "\u89E6\u53D1\u6761\u4EF6", className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400" }),
        /* @__PURE__ */ jsxs9("select", { value: draft.level, onChange: (e) => setDraft({ ...draft, level: e.target.value }), className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400", children: [
          /* @__PURE__ */ jsx10("option", { value: "\u9AD8", children: "\u9AD8" }),
          /* @__PURE__ */ jsx10("option", { value: "\u4E2D", children: "\u4E2D" }),
          /* @__PURE__ */ jsx10("option", { value: "\u4F4E", children: "\u4F4E" })
        ] }),
        /* @__PURE__ */ jsx10("input", { value: draft.action, onChange: (e) => setDraft({ ...draft, action: e.target.value }), placeholder: "\u5904\u7F6E\u52A8\u4F5C", className: "w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-brand-400" })
      ] }),
      /* @__PURE__ */ jsxs9("div", { className: "mt-4 flex justify-end gap-2", children: [
        /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "ghost", onClick: () => setNewOpen(false), children: "\u53D6\u6D88" }),
        /* @__PURE__ */ jsx10(Button, { size: "sm", variant: "primary", onClick: () => {
          add();
          setNewOpen(false);
          setDraft({ name: "", category: "\u53F8\u6CD5\u6D89\u8BC9", condition: "", level: "\u4E2D", action: "" });
        }, children: "\u786E\u8BA4\u65B0\u589E" })
      ] })
    ] })
  ] });
...
function EntAlertWorkbench() {
  const ent = useEnterpriseData();
  const nav = useNavigate();
  useMinuteTick();
  const pageFlow = usePageFlow("/console/ep/alert-workbench");
  const [lvl, setLvl] = useState10("");
  const filtered = ent.alerts.filter((a) => !lvl || a.level === lvl);
  const lc = { RED: 0, YELLOW: 0, OPPORTUNITY: 0 };
  ent.alerts.forEach((a) => {
    lc[a.level] = (lc[a.level] ?? 0) + 1;
  });
  const rows = filtered.map((a) => ({
    id: a.id,
    id2: a.id,
    entName: a.entName,
    category: { v: a.category, kind: "blue" },
    ruleName: a.ruleName,
    level: { v: a.level === "RED" ? "\u7EA2\u706F" : a.level === "YELLOW" ? "\u9EC4\u706F" : "\u673A\u4F1A", kind: ALERT_KIND[a.level] },
    detail: a.detail,
  ...
  const setAlertFlow = (id, next, at) => updateEnterpriseData((d) => ({
    ...d,
  ...
  const cols = [
    ...
    },
    {
      ...
      fixed: "right",
      width: "170px",
      tag: { kind: "sample", value: "enterpriseData.json.flowState" },
      render: (r) => /* @__PURE__ */ jsx10(
        FlowStateCell,
        {
          flowId: flowIdOfRow(r, pageFlow),
  ...
  return /* @__PURE__ */ jsxs9("div", { style: { padding: 24, maxWidth: 1360 }, children: [
    /* @__PURE__ */ jsx10(
      ...
      {
        title: "\u9884\u8B66\u5904\u7F6E\u5DE5\u4F5C\u53F0",
        crumb: `${CRUMB2} / \u98CE\u9669\u9884\u8B66\u4E2D\u5FC3 / \u9884\u8B66\u5904\u7F6E\u5DE5\u4F5C\u53F0`,
        subtitle: "\u4F01\u4E1A\u9884\u8B66\u961F\u5217 \xB7 \u9010\u6761\u6838\u5B9E\u3001\u53D1\u8D77\u5904\u7F6E\uFF08\u6570\u636E\u6765\u6E90\u5DF2\u5207\u6362\u4E3A\u4F01\u4E1A\u9884\u8B66\uFF09",
        actions: /* @__PURE__ */ jsxs9(Fragment9, { children: [
          /* @__PURE__ */ jsx10(Sam, { value: "enterpriseData.json.alerts" }),
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u7EDF\u8BA1" })
        ] })
      }
    ),
    /* @__PURE__ */ jsxs9("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, minmax(0,1fr))", gap: 12, marginBottom: 16 }, children: [
      /* @__PURE__ */ jsx10(StatCard, { label: "\u9884\u8B66\u603B\u6570", value: String(ent.alerts.length), accent: "brand" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u7EA2\u706F\u9884\u8B66", value: String(lc.RED), accent: "rose" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u9EC4\u706F\u9884\u8B66", value: String(lc.YELLOW), accent: "amber" }),
      /* @__PURE__ */ jsx10(StatCard, { label: "\u5F85\u5904\u7F6E", value: String(ent.alerts.filter((a) => a.status === "\u5F85\u5904\u7F6E").length), accent: "rose" })
    ] }),
    /* @__PURE__ */ jsx10(
      Panel,
      {
        ...
        desc: /* @__PURE__ */ jsxs9("span", { children: [
          "\u7B5B\u9009\u540E ",
          /* @__PURE__ */ jsx10("b", { children: filtered.length }),
          " \u6761 \xB7 ",
          /* @__PURE__ */ jsx10(Cal, { label: "\u5B9E\u65F6\u8FC7\u6EE4" })
        ] }),
        actions: /* @__PURE__ */ jsxs9("select", { value: lvl, onChange: (e) => setLvl(e.target.value), style: { padding: "4px 8px", borderRadius: 6, border: "1px solid #E2E8F0", fontSize: 12, background: "#fff" }, children: [
          /* @__PURE__ */ jsx10("option", { value: "", children: "\u5168\u90E8\u7B49\u7EA7" }),
          /* @__PURE__ */ jsx10("option", { value: "RED", children: "\u7EA2\u706F" }),
          /* @__PURE__ */ jsx10("option", { value: "YELLOW", children: "\u9EC4\u706F" }),
          /* @__PURE__ */ jsx10("option", { value: "OPPORTUNITY", children: "\u673A\u4F1A" })
        ] }),
        children: /* @__PURE__ */ jsx10(
          DataTable,
          {
            ...
            actions: (r) => {
              ...
              return /* @__PURE__ */ jsx10("div", { style: { display: "flex", gap: 6 }, children: /* @__PURE__ */ jsx10(
                "button",
                {
                  type: "button",
                  onClick: () => {
                    setQiyeSelected(a.entName, a.entKeyNo ?? "");
                    nav("/console/ep/qiye-profile");
                  },
                  style: { padding: "3px 12px", borderRadius: 6, border: "1px solid #C7D2FE", background: "#EFF6FF", color: "#1D4ED8", fontSize: 12, cursor: "pointer" },
                  children: "\u67E5\u770B\u6863\u6848"
